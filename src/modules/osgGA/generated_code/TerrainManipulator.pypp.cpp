...
struct TerrainManipulator_wrapper : osgGA::TerrainManipulator, bp::wrapper< osgGA::TerrainManipulator > {

    TerrainManipulator_wrapper(int flags=DEFAULT_SETTINGS )
    : osgGA::TerrainManipulator( flags )
      , bp::wrapper< osgGA::TerrainManipulator >(){
        // constructor
    ...
    virtual char const * className(  ) const  {
        if( bp::override func_className = this->get_override( "className" ) )
            ...
            return this->osgGA::TerrainManipulator::className(  );
        }
    }
    ...
    virtual ::osg::Object * clone( ::osg::CopyOp const & copyop ) const  {
        if( bp::override func_clone = this->get_override( "clone" ) )
            ...
            return this->osgGA::TerrainManipulator::clone( boost::ref(copyop) );
        }
    }
    
    ::osg::Object * default_clone( ::osg::CopyOp const & copyop ) const  {
        return osgGA::TerrainManipulator::clone( boost::ref(copyop) );
    }
    ...
    virtual ::osg::Object * cloneType(  ) const  {
        if( bp::override func_cloneType = this->get_override( "cloneType" ) )
            ...
            return this->osgGA::TerrainManipulator::cloneType(  );
        }
    }
    ...
    bool intersect( ::osg::Vec3d const & start, ::osg::Vec3d const & end, ::osg::Vec3d & intersection ) const {
        return osgGA::TerrainManipulator::intersect( boost::ref(start), boost::ref(end), boost::ref(intersection) );
    }
    ...
    virtual bool isSameKindAs( ::osg::Object const * obj ) const  {
        if( bp::override func_isSameKindAs = this->get_override( "isSameKindAs" ) )
            ...
            return this->osgGA::TerrainManipulator::isSameKindAs( boost::python::ptr(obj) );
        }
    }
    
    bool default_isSameKindAs( ::osg::Object const * obj ) const  {
        return osgGA::TerrainManipulator::isSameKindAs( boost::python::ptr(obj) );
    }
    ...
    virtual char const * libraryName(  ) const  {
        if( bp::override func_libraryName = this->get_override( "libraryName" ) )
            ...
            return this->osgGA::TerrainManipulator::libraryName(  );
        }
    }
    ...
    virtual bool performMovementMiddleMouseButton( double const eventTimeDelta, double const dx, double const dy ){
        if( bp::override func_performMovementMiddleMouseButton = this->get_override( "performMovementMiddleMouseButton" ) )
            ...
            return this->osgGA::TerrainManipulator::performMovementMiddleMouseButton( eventTimeDelta, dx, dy );
        }
    }
    ...
    virtual bool performMovementRightMouseButton( double const eventTimeDelta, double const dx, double const dy ){
        if( bp::override func_performMovementRightMouseButton = this->get_override( "performMovementRightMouseButton" ) )
            ...
            return this->osgGA::TerrainManipulator::performMovementRightMouseButton( eventTimeDelta, dx, dy );
        }
    }
    ...
    virtual void setByMatrix( ::osg::Matrixd const & matrix ) {
        if( bp::override func_setByMatrix = this->get_override( "setByMatrix" ) )
            ...
            this->osgGA::TerrainManipulator::setByMatrix( boost::ref(matrix) );
        }
    }
    
    void default_setByMatrix( ::osg::Matrixd const & matrix ) {
        osgGA::TerrainManipulator::setByMatrix( boost::ref(matrix) );
    }
    ...
    virtual void setNode( ::osg::Node * node ) {
        if( bp::override func_setNode = this->get_override( "setNode" ) )
            ...
            this->osgGA::TerrainManipulator::setNode( boost::python::ptr(node) );
        }
    }
    
    void default_setNode( ::osg::Node * node ) {
        osgGA::TerrainManipulator::setNode( boost::python::ptr(node) );
    }

    virtual void setRotationMode( ::osgGA::TerrainManipulator::RotationMode mode ) {
        if( bp::override func_setRotationMode = this->get_override( "setRotationMode" ) )
            func_setRotationMode( mode );
        else{
            this->osgGA::TerrainManipulator::setRotationMode( mode );
        }
    }
    
    void default_setRotationMode( ::osgGA::TerrainManipulator::RotationMode mode ) {
        osgGA::TerrainManipulator::setRotationMode( mode );
    }
    ...
    virtual void setTransformation( ::osg::Vec3d const & eye, ::osg::Vec3d const & center, ::osg::Vec3d const & up ) {
        if( bp::override func_setTransformation = this->get_override( "setTransformation" ) )
            ...
            this->osgGA::TerrainManipulator::setTransformation( boost::ref(eye), boost::ref(center), boost::ref(up) );
        }
    }
    
    void default_setTransformation( ::osg::Vec3d const & eye, ::osg::Vec3d const & center, ::osg::Vec3d const & up ) {
        osgGA::TerrainManipulator::setTransformation( boost::ref(eye), boost::ref(center), boost::ref(up) );
    }
    ...
    static boost::python::object default_handle_d0ba65b51c8a2afc5afff00aad1b91b3( ::osgGA::GUIEventHandler & inst, ::osgGA::GUIEventAdapter & ea, ::osgGA::GUIActionAdapter & aa, ::osg::Object * arg2, ::osg::NodeVisitor * arg3 ){
        bool result;
        if( dynamic_cast< TerrainManipulator_wrapper * >( boost::addressof( inst ) ) ){
...
static int DEFAULT_SETTINGS = osgGA::TerrainManipulator::DEFAULT_SETTINGS;

void register_TerrainManipulator_class(){

    { //::osgGA::TerrainManipulator
        typedef bp::class_< TerrainManipulator_wrapper, bp::bases< osgGA::OrbitManipulator >, osg::ref_ptr< TerrainManipulator_wrapper >, boost::noncopyable > TerrainManipulator_exposer_t;
        TerrainManipulator_exposer_t TerrainManipulator_exposer = TerrainManipulator_exposer_t( "TerrainManipulator", bp::init< bp::optional< int > >(( bp::arg("flags")=(int)(DEFAULT_SETTINGS) )) );
        bp::scope TerrainManipulator_scope( TerrainManipulator_exposer );
        bp::enum_< osgGA::TerrainManipulator::RotationMode>("RotationMode")
            .value("ELEVATION_AZIM_ROLL", osgGA::TerrainManipulator::ELEVATION_AZIM_ROLL)
            .value("ELEVATION_AZIM", osgGA::TerrainManipulator::ELEVATION_AZIM)
            .export_values()
            ;
        ...
        { //::osgGA::TerrainManipulator::clampOrientation
            ...
            TerrainManipulator_exposer.def( 
                "clampOrientation"
                , clampOrientation_function_type( &TerrainManipulator_wrapper::clampOrientation ) );
        ...
        { //::osgGA::TerrainManipulator::className
            ...
            TerrainManipulator_exposer.def( 
                "className"
                , className_function_type(&::osgGA::TerrainManipulator::className)
                , default_className_function_type(&TerrainManipulator_wrapper::default_className) );
        ...
        { //::osgGA::TerrainManipulator::clone
            ...
            TerrainManipulator_exposer.def( 
                "clone"
                , clone_function_type(&::osgGA::TerrainManipulator::clone)
                , default_clone_function_type(&TerrainManipulator_wrapper::default_clone)
                , ( bp::arg("copyop") )
        ...
        { //::osgGA::TerrainManipulator::cloneType
            ...
            TerrainManipulator_exposer.def( 
                "cloneType"
                , cloneType_function_type(&::osgGA::TerrainManipulator::cloneType)
                , default_cloneType_function_type(&TerrainManipulator_wrapper::default_cloneType)
                , bp::return_value_policy< bp::reference_existing_object >() );
        ...
        { //::osgGA::TerrainManipulator::getRotationMode
            ...
            TerrainManipulator_exposer.def( 
                "getRotationMode"
                , getRotationMode_function_type( &::osgGA::TerrainManipulator::getRotationMode ) );
        ...
        { //::osgGA::TerrainManipulator::intersect
            ...
            TerrainManipulator_exposer.def( 
                "intersect"
                , intersect_function_type( &TerrainManipulator_wrapper::intersect )
        ...
        { //::osgGA::TerrainManipulator::isSameKindAs
            ...
            TerrainManipulator_exposer.def( 
                "isSameKindAs"
                , isSameKindAs_function_type(&::osgGA::TerrainManipulator::isSameKindAs)
                , default_isSameKindAs_function_type(&TerrainManipulator_wrapper::default_isSameKindAs)
                , ( bp::arg("obj") ) );
        ...
        { //::osgGA::TerrainManipulator::libraryName
            ...
            TerrainManipulator_exposer.def( 
                "libraryName"
                , libraryName_function_type(&::osgGA::TerrainManipulator::libraryName)
                , default_libraryName_function_type(&TerrainManipulator_wrapper::default_libraryName) );
        ...
        { //::osgGA::TerrainManipulator::performMovementMiddleMouseButton
            ...
            TerrainManipulator_exposer.def( 
                ...
                , performMovementMiddleMouseButton_function_type( &TerrainManipulator_wrapper::default_performMovementMiddleMouseButton )
        ...
        { //::osgGA::TerrainManipulator::performMovementRightMouseButton
            ...
            TerrainManipulator_exposer.def( 
                ...
                , performMovementRightMouseButton_function_type( &TerrainManipulator_wrapper::default_performMovementRightMouseButton )
                , ( bp::arg("eventTimeDelta"), bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::TerrainManipulator::setByMatrix
            ...
            TerrainManipulator_exposer.def( 
                "setByMatrix"
                , setByMatrix_function_type(&::osgGA::TerrainManipulator::setByMatrix)
                , default_setByMatrix_function_type(&TerrainManipulator_wrapper::default_setByMatrix)
                , ( bp::arg("matrix") ) );
        ...
        { //::osgGA::TerrainManipulator::setNode
            ...
            TerrainManipulator_exposer.def( 
                "setNode"
                , setNode_function_type(&::osgGA::TerrainManipulator::setNode)
                , default_setNode_function_type(&TerrainManipulator_wrapper::default_setNode)
                , ( bp::arg("node") ) );
        ...
        { //::osgGA::TerrainManipulator::setRotationMode
            ...
            TerrainManipulator_exposer.def( 
                "setRotationMode"
                , setRotationMode_function_type(&::osgGA::TerrainManipulator::setRotationMode)
                , default_setRotationMode_function_type(&TerrainManipulator_wrapper::default_setRotationMode)
                , ( bp::arg("mode") ) );
        ...
        { //::osgGA::TerrainManipulator::setTransformation
            ...
            TerrainManipulator_exposer.def( 
                "setTransformation"
                , setTransformation_function_type(&::osgGA::TerrainManipulator::setTransformation)
                , default_setTransformation_function_type(&TerrainManipulator_wrapper::default_setTransformation)
        ...
        { //::osgGA::OrbitManipulator::allocAnimationData
            ...
            TerrainManipulator_exposer.def( 
                "allocAnimationData"
                , allocAnimationData_function_type( &TerrainManipulator_wrapper::default_allocAnimationData ) );
        ...
        { //::osgGA::StandardManipulator::allocateRelativeFlag
            ...
            TerrainManipulator_exposer.def( 
                ...
                , allocateRelativeFlag_function_type( &TerrainManipulator_wrapper::allocateRelativeFlag ) );
        ...
        { //::osgGA::OrbitManipulator::applyAnimationStep
            ...
            TerrainManipulator_exposer.def( 
                "applyAnimationStep"
                , applyAnimationStep_function_type( &TerrainManipulator_wrapper::default_applyAnimationStep )
        ...
        { //::osgGA::CameraManipulator::computeHomePosition
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_computeHomePosition_function_type(&TerrainManipulator_wrapper::default_computeHomePosition)
        ...
        { //::osgGA::GUIEventHandler::event
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_event_function_type(&TerrainManipulator_wrapper::default_event)
        ...
        { //::osgGA::StandardManipulator::finishAnimation
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_finishAnimation_function_type(&TerrainManipulator_wrapper::default_finishAnimation) );
        ...
        { //::osgGA::StandardManipulator::fixVerticalAxis
            ...
            TerrainManipulator_exposer.def( 
                "fixVerticalAxis"
                , fixVerticalAxis_function_type( &TerrainManipulator_wrapper::fixVerticalAxis )
        ...
        { //::osgGA::StandardManipulator::flushMouseEventStack
            ...
            TerrainManipulator_exposer.def( 
                ...
                , flushMouseEventStack_function_type( &TerrainManipulator_wrapper::flushMouseEventStack ) );
        ...
        { //::osgGA::OrbitManipulator::getFusionDistanceMode
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getFusionDistanceMode_function_type(&TerrainManipulator_wrapper::default_getFusionDistanceMode) );
        ...
        { //::osgGA::OrbitManipulator::getFusionDistanceValue
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getFusionDistanceValue_function_type(&TerrainManipulator_wrapper::default_getFusionDistanceValue) );
        ...
        { //::osgGA::CameraManipulator::getHomePosition
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getHomePosition_function_type(&TerrainManipulator_wrapper::default_getHomePosition)
                , ( bp::arg("eye"), bp::arg("center"), bp::arg("up") ) );
        ...
        { //::osgGA::OrbitManipulator::getInverseMatrix
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getInverseMatrix_function_type(&TerrainManipulator_wrapper::default_getInverseMatrix) );
        ...
        { //::osgGA::OrbitManipulator::getMatrix
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getMatrix_function_type(&TerrainManipulator_wrapper::default_getMatrix) );
        ...
        { //::osgGA::StandardManipulator::getNode
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getNode_function_type(&TerrainManipulator_wrapper::default_getNode)
        ...
        { //::osgGA::StandardManipulator::getRelativeFlag
            ...
            TerrainManipulator_exposer.def( 
                "getRelativeFlag"
                , getRelativeFlag_function_type( &TerrainManipulator_wrapper::getRelativeFlag )
                , ( bp::arg("index") ) );
        ...
        { //::osgGA::StandardManipulator::getThrowScale
            ...
            TerrainManipulator_exposer.def( 
                "getThrowScale"
                , getThrowScale_function_type( &TerrainManipulator_wrapper::getThrowScale )
        ...
        { //::osgGA::OrbitManipulator::getTransformation
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getTransformation_function_type(&TerrainManipulator_wrapper::default_getTransformation)
        ...
        { //::osgGA::StandardManipulator::getUsage
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_getUsage_function_type(&TerrainManipulator_wrapper::default_getUsage)
                , ( bp::arg("usage") ) );
        ...
        { //::osgGA::GUIEventHandler::handle
            ...
            TerrainManipulator_exposer.def( 
                "handle"
                , default_handle_function_type( &TerrainManipulator_wrapper::default_handle_d0ba65b51c8a2afc5afff00aad1b91b3 )
        ...
        { //::osgGA::StandardManipulator::handle
            ...
            TerrainManipulator_exposer.def( 
                "handle"
                , default_handle_function_type( &TerrainManipulator_wrapper::default_handle )
        ...
        { //::osgGA::StandardManipulator::home
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_home_194db6d6ec8fbf447721ccd081e44fc3_function_type( &TerrainManipulator_wrapper::default_home_194db6d6ec8fbf447721ccd081e44fc3 )
                , ( bp::arg("inst"), bp::arg("ea"), bp::arg("us") ) );
        ...
        { //::osgGA::StandardManipulator::home
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_home_function_type(&TerrainManipulator_wrapper::default_home)
                , ( bp::arg("arg0") ) );
        ...
        { //::osgGA::StandardManipulator::init
            ...
            TerrainManipulator_exposer.def( 
                "init"
                , default_init_function_type( &TerrainManipulator_wrapper::default_init )
                , ( bp::arg("inst"), bp::arg("ea"), bp::arg("us") ) );
        ...
        { //::osgGA::StandardManipulator::isMouseMoving
            ...
            TerrainManipulator_exposer.def( 
                "isMouseMoving"
                , isMouseMoving_function_type( &TerrainManipulator_wrapper::default_isMouseMoving ) );
        ...
        { //::osgGA::OrbitManipulator::panModel
            ...
            TerrainManipulator_exposer.def( 
                "panModel"
                , panModel_function_type( &TerrainManipulator_wrapper::default_panModel )
        ...
        { //::osgGA::OrbitManipulator::performMouseDeltaMovement
            ...
            TerrainManipulator_exposer.def( 
                ...
                , performMouseDeltaMovement_function_type( &TerrainManipulator_wrapper::default_performMouseDeltaMovement )
                , ( bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::OrbitManipulator::performMovementLeftMouseButton
            ...
            TerrainManipulator_exposer.def( 
                ...
                , performMovementLeftMouseButton_function_type( &TerrainManipulator_wrapper::default_performMovementLeftMouseButton )
                , ( bp::arg("eventTimeDelta"), bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::OrbitManipulator::rotateTrackball
            ...
            TerrainManipulator_exposer.def( 
                "rotateTrackball"
                , rotateTrackball_function_type( &TerrainManipulator_wrapper::default_rotateTrackball )
        ...
        { //::osgGA::OrbitManipulator::rotateWithFixedVertical
            ...
            TerrainManipulator_exposer.def( 
                ...
                , rotateWithFixedVertical_function_type( &TerrainManipulator_wrapper::default_rotateWithFixedVertical )
                , ( bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::StandardManipulator::rotateYawPitch
            ...
            TerrainManipulator_exposer.def( 
                "rotateYawPitch"
                , rotateYawPitch_function_type( &TerrainManipulator_wrapper::rotateYawPitch )
        ...
        { //::osgGA::StandardManipulator::setAllowThrow
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setAllowThrow_function_type(&TerrainManipulator_wrapper::default_setAllowThrow)
                , ( bp::arg("allowThrow") ) );
        ...
        { //::osgGA::StandardManipulator::setAnimationTime
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setAnimationTime_function_type(&TerrainManipulator_wrapper::default_setAnimationTime)
                , ( bp::arg("t") ) );
        ...
        { //::osgGA::CameraManipulator::setAutoComputeHomePosition
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setAutoComputeHomePosition_function_type(&TerrainManipulator_wrapper::default_setAutoComputeHomePosition)
                , ( bp::arg("flag") ) );
        ...
        { //::osgGA::OrbitManipulator::setByInverseMatrix
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setByInverseMatrix_function_type(&TerrainManipulator_wrapper::default_setByInverseMatrix)
                , ( bp::arg("matrix") ) );
        ...
        { //::osgGA::OrbitManipulator::setCenter
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setCenter_function_type(&TerrainManipulator_wrapper::default_setCenter)
                , ( bp::arg("center") ) );
        ...
        { //::osgGA::CameraManipulator::setCoordinateFrameCallback
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setCoordinateFrameCallback_function_type(&TerrainManipulator_wrapper::default_setCoordinateFrameCallback)
                , ( bp::arg("cb") ) );
        ...
        { //::osgGA::OrbitManipulator::setDistance
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setDistance_function_type(&TerrainManipulator_wrapper::default_setDistance)
                , ( bp::arg("distance") ) );
        ...
        { //::osgGA::CameraManipulator::setHomePosition
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setHomePosition_function_type(&TerrainManipulator_wrapper::default_setHomePosition)
        ...
        { //::osgGA::OrbitManipulator::setMinimumDistance
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setMinimumDistance_function_type(&TerrainManipulator_wrapper::default_setMinimumDistance)
        ...
        { //::osgGA::StandardManipulator::setRelativeFlag
            ...
            TerrainManipulator_exposer.def( 
                "setRelativeFlag"
                , setRelativeFlag_function_type( &TerrainManipulator_wrapper::setRelativeFlag )
        ...
        { //::osgGA::OrbitManipulator::setRotation
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setRotation_function_type(&TerrainManipulator_wrapper::default_setRotation)
                , ( bp::arg("rotation") ) );
        ...
        { //::osgGA::OrbitManipulator::setTrackballSize
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setTrackballSize_function_type(&TerrainManipulator_wrapper::default_setTrackballSize)
                , ( bp::arg("size") ) );
        ...
        { //::osgGA::StandardManipulator::setVerticalAxisFixed
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setVerticalAxisFixed_function_type(&TerrainManipulator_wrapper::default_setVerticalAxisFixed)
                , ( bp::arg("value") ) );
        ...
        { //::osgGA::OrbitManipulator::setWheelZoomFactor
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_setWheelZoomFactor_function_type(&TerrainManipulator_wrapper::default_setWheelZoomFactor)
        ...
        { //::osgGA::OrbitManipulator::tb_project_to_sphere
            ...
            TerrainManipulator_exposer.def( 
                ...
                , tb_project_to_sphere_function_type( &TerrainManipulator_wrapper::tb_project_to_sphere )
        ...
        { //::osgGA::OrbitManipulator::trackball
            ...
            TerrainManipulator_exposer.def( 
                "trackball"
                , trackball_function_type( &TerrainManipulator_wrapper::trackball )
        ...
        { //::osgGA::CameraManipulator::updateCamera
            ...
            TerrainManipulator_exposer.def( 
                ...
                , default_updateCamera_function_type(&TerrainManipulator_wrapper::default_updateCamera)
                , ( bp::arg("camera") ) );
        ...
        { //::osgGA::OrbitManipulator::zoomModel
            ...
            TerrainManipulator_exposer.def( 
                "zoomModel"
                , zoomModel_function_type( &TerrainManipulator_wrapper::default_zoomModel )
                , ( bp::arg("dy"), bp::arg("pushForwardIfNeeded")=(bool)(true) ) );
        
        }
        TerrainManipulator_exposer.staticmethod( "allocateRelativeFlag" );
        TerrainManipulator_exposer.staticmethod( "fixVerticalAxis" );
        TerrainManipulator_exposer.staticmethod( "rotateYawPitch" );
    }
