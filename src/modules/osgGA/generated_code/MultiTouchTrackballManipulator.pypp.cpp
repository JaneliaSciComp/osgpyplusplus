...
struct MultiTouchTrackballManipulator_wrapper : osgGA::MultiTouchTrackballManipulator, bp::wrapper< osgGA::MultiTouchTrackballManipulator > {

    MultiTouchTrackballManipulator_wrapper(int flags=DEFAULT_SETTINGS )
    : osgGA::MultiTouchTrackballManipulator( flags )
      , bp::wrapper< osgGA::MultiTouchTrackballManipulator >(){
        // constructor
    ...
    virtual char const * className(  ) const  {
        if( bp::override func_className = this->get_override( "className" ) )
            ...
            return this->osgGA::MultiTouchTrackballManipulator::className(  );
        }
    }
    ...
    virtual ::osg::Object * clone( ::osg::CopyOp const & copyop ) const  {
        if( bp::override func_clone = this->get_override( "clone" ) )
            ...
            return this->osgGA::MultiTouchTrackballManipulator::clone( boost::ref(copyop) );
        }
    }
    
    ::osg::Object * default_clone( ::osg::CopyOp const & copyop ) const  {
        return osgGA::MultiTouchTrackballManipulator::clone( boost::ref(copyop) );
    }
    ...
    virtual ::osg::Object * cloneType(  ) const  {
        if( bp::override func_cloneType = this->get_override( "cloneType" ) )
            ...
            return this->osgGA::MultiTouchTrackballManipulator::cloneType(  );
        }
    }
    ...
    virtual bool handle( ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        ...
        if( bpl::override func_handle = this->get_override( "handle" ) ){
            ...
            return osgGA::MultiTouchTrackballManipulator::handle( boost::ref(ea), boost::ref(us) );
        }
    }
    
    static boost::python::object default_handle( ::osgGA::MultiTouchTrackballManipulator & inst, ::osgGA::GUIEventAdapter & ea, ::osgGA::GUIActionAdapter & us ){
        bool result;
        if( dynamic_cast< MultiTouchTrackballManipulator_wrapper * >( boost::addressof( inst ) ) ){
            result = inst.::osgGA::MultiTouchTrackballManipulator::handle(ea, us);
        }
        else{
    ...
    void handleMultiTouchDrag( ::osgGA::GUIEventAdapter::TouchData * now, ::osgGA::GUIEventAdapter::TouchData * last, double const eventTimeDelta ){
        osgGA::MultiTouchTrackballManipulator::handleMultiTouchDrag( boost::python::ptr(now), boost::python::ptr(last), eventTimeDelta );
    }
    ...
    virtual bool isSameKindAs( ::osg::Object const * obj ) const  {
        if( bp::override func_isSameKindAs = this->get_override( "isSameKindAs" ) )
            ...
            return this->osgGA::MultiTouchTrackballManipulator::isSameKindAs( boost::python::ptr(obj) );
        }
    }
    
    bool default_isSameKindAs( ::osg::Object const * obj ) const  {
        return osgGA::MultiTouchTrackballManipulator::isSameKindAs( boost::python::ptr(obj) );
    }
    ...
    virtual char const * libraryName(  ) const  {
        if( bp::override func_libraryName = this->get_override( "libraryName" ) )
            ...
            return this->osgGA::MultiTouchTrackballManipulator::libraryName(  );
        }
    }
...
static int DEFAULT_SETTINGS = osgGA::MultiTouchTrackballManipulator::DEFAULT_SETTINGS;

void register_MultiTouchTrackballManipulator_class(){

    { //::osgGA::MultiTouchTrackballManipulator
        typedef bp::class_< MultiTouchTrackballManipulator_wrapper, bp::bases< osgGA::TrackballManipulator >, osg::ref_ptr< MultiTouchTrackballManipulator_wrapper >, boost::noncopyable > MultiTouchTrackballManipulator_exposer_t;
        MultiTouchTrackballManipulator_exposer_t MultiTouchTrackballManipulator_exposer = MultiTouchTrackballManipulator_exposer_t( "MultiTouchTrackballManipulator", bp::init< bp::optional< int > >(( bp::arg("flags")=(int)(DEFAULT_SETTINGS) )) );
        bp::scope MultiTouchTrackballManipulator_scope( MultiTouchTrackballManipulator_exposer );
        ...
        { //::osgGA::MultiTouchTrackballManipulator::className
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "className"
                , className_function_type(&::osgGA::MultiTouchTrackballManipulator::className)
                , default_className_function_type(&MultiTouchTrackballManipulator_wrapper::default_className) );
        ...
        { //::osgGA::MultiTouchTrackballManipulator::clone
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "clone"
                , clone_function_type(&::osgGA::MultiTouchTrackballManipulator::clone)
                , default_clone_function_type(&MultiTouchTrackballManipulator_wrapper::default_clone)
                , ( bp::arg("copyop") )
        ...
        { //::osgGA::MultiTouchTrackballManipulator::cloneType
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "cloneType"
                , cloneType_function_type(&::osgGA::MultiTouchTrackballManipulator::cloneType)
                , default_cloneType_function_type(&MultiTouchTrackballManipulator_wrapper::default_cloneType)
                , bp::return_value_policy< bp::reference_existing_object >() );
        
        }
        { //::osgGA::MultiTouchTrackballManipulator::handle
        
            typedef boost::python::object ( *default_handle_function_type )( ::osgGA::MultiTouchTrackballManipulator &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & );
            
            MultiTouchTrackballManipulator_exposer.def( 
                "handle"
                , default_handle_function_type( &MultiTouchTrackballManipulator_wrapper::default_handle )
        ...
        { //::osgGA::MultiTouchTrackballManipulator::handleMultiTouchDrag
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , handleMultiTouchDrag_function_type( &MultiTouchTrackballManipulator_wrapper::handleMultiTouchDrag )
                , ( bp::arg("now"), bp::arg("last"), bp::arg("eventTimeDelta") ) );
        ...
        { //::osgGA::MultiTouchTrackballManipulator::isSameKindAs
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "isSameKindAs"
                , isSameKindAs_function_type(&::osgGA::MultiTouchTrackballManipulator::isSameKindAs)
                , default_isSameKindAs_function_type(&MultiTouchTrackballManipulator_wrapper::default_isSameKindAs)
                , ( bp::arg("obj") ) );
        ...
        { //::osgGA::MultiTouchTrackballManipulator::libraryName
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "libraryName"
                , libraryName_function_type(&::osgGA::MultiTouchTrackballManipulator::libraryName)
                , default_libraryName_function_type(&MultiTouchTrackballManipulator_wrapper::default_libraryName) );
        ...
        { //::osgGA::OrbitManipulator::allocAnimationData
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "allocAnimationData"
                , allocAnimationData_function_type( &MultiTouchTrackballManipulator_wrapper::default_allocAnimationData ) );
        ...
        { //::osgGA::StandardManipulator::allocateRelativeFlag
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , allocateRelativeFlag_function_type( &MultiTouchTrackballManipulator_wrapper::allocateRelativeFlag ) );
        ...
        { //::osgGA::OrbitManipulator::applyAnimationStep
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "applyAnimationStep"
                , applyAnimationStep_function_type( &MultiTouchTrackballManipulator_wrapper::default_applyAnimationStep )
        ...
        { //::osgGA::CameraManipulator::computeHomePosition
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_computeHomePosition_function_type(&MultiTouchTrackballManipulator_wrapper::default_computeHomePosition)
        ...
        { //::osgGA::GUIEventHandler::event
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_event_function_type(&MultiTouchTrackballManipulator_wrapper::default_event)
        ...
        { //::osgGA::StandardManipulator::finishAnimation
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_finishAnimation_function_type(&MultiTouchTrackballManipulator_wrapper::default_finishAnimation) );
        ...
        { //::osgGA::StandardManipulator::fixVerticalAxis
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "fixVerticalAxis"
                , fixVerticalAxis_function_type( &MultiTouchTrackballManipulator_wrapper::fixVerticalAxis )
        ...
        { //::osgGA::StandardManipulator::flushMouseEventStack
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , flushMouseEventStack_function_type( &MultiTouchTrackballManipulator_wrapper::flushMouseEventStack ) );
        ...
        { //::osgGA::OrbitManipulator::getFusionDistanceMode
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getFusionDistanceMode_function_type(&MultiTouchTrackballManipulator_wrapper::default_getFusionDistanceMode) );
        ...
        { //::osgGA::OrbitManipulator::getFusionDistanceValue
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getFusionDistanceValue_function_type(&MultiTouchTrackballManipulator_wrapper::default_getFusionDistanceValue) );
        ...
        { //::osgGA::CameraManipulator::getHomePosition
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getHomePosition_function_type(&MultiTouchTrackballManipulator_wrapper::default_getHomePosition)
        ...
        { //::osgGA::OrbitManipulator::getInverseMatrix
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getInverseMatrix_function_type(&MultiTouchTrackballManipulator_wrapper::default_getInverseMatrix) );
        ...
        { //::osgGA::OrbitManipulator::getMatrix
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getMatrix_function_type(&MultiTouchTrackballManipulator_wrapper::default_getMatrix) );
        ...
        { //::osgGA::StandardManipulator::getNode
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getNode_function_type(&MultiTouchTrackballManipulator_wrapper::default_getNode)
        ...
        { //::osgGA::StandardManipulator::getRelativeFlag
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "getRelativeFlag"
                , getRelativeFlag_function_type( &MultiTouchTrackballManipulator_wrapper::getRelativeFlag )
                , ( bp::arg("index") ) );
        ...
        { //::osgGA::StandardManipulator::getThrowScale
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "getThrowScale"
                , getThrowScale_function_type( &MultiTouchTrackballManipulator_wrapper::getThrowScale )
        ...
        { //::osgGA::OrbitManipulator::getTransformation
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getTransformation_function_type(&MultiTouchTrackballManipulator_wrapper::default_getTransformation)
        ...
        { //::osgGA::StandardManipulator::getUsage
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_getUsage_function_type(&MultiTouchTrackballManipulator_wrapper::default_getUsage)
                , ( bp::arg("usage") ) );
        ...
        { //::osgGA::GUIEventHandler::handle
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "handle"
                , default_handle_function_type( &MultiTouchTrackballManipulator_wrapper::default_handle_d0ba65b51c8a2afc5afff00aad1b91b3 )
        ...
        { //::osgGA::StandardManipulator::home
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_home_function_type(&MultiTouchTrackballManipulator_wrapper::default_home)
                , ( bp::arg("arg0") ) );
        ...
        { //::osgGA::StandardManipulator::init
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "init"
                , default_init_function_type( &MultiTouchTrackballManipulator_wrapper::default_init )
                , ( bp::arg("inst"), bp::arg("ea"), bp::arg("us") ) );
        ...
        { //::osgGA::StandardManipulator::isMouseMoving
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "isMouseMoving"
                , isMouseMoving_function_type( &MultiTouchTrackballManipulator_wrapper::default_isMouseMoving ) );
        ...
        { //::osgGA::OrbitManipulator::panModel
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "panModel"
                , panModel_function_type( &MultiTouchTrackballManipulator_wrapper::default_panModel )
        ...
        { //::osgGA::OrbitManipulator::performMouseDeltaMovement
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , performMouseDeltaMovement_function_type( &MultiTouchTrackballManipulator_wrapper::default_performMouseDeltaMovement )
                , ( bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::OrbitManipulator::performMovementLeftMouseButton
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , performMovementLeftMouseButton_function_type( &MultiTouchTrackballManipulator_wrapper::default_performMovementLeftMouseButton )
        ...
        { //::osgGA::OrbitManipulator::performMovementMiddleMouseButton
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , performMovementMiddleMouseButton_function_type( &MultiTouchTrackballManipulator_wrapper::default_performMovementMiddleMouseButton )
                , ( bp::arg("eventTimeDelta"), bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::OrbitManipulator::performMovementRightMouseButton
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , performMovementRightMouseButton_function_type( &MultiTouchTrackballManipulator_wrapper::default_performMovementRightMouseButton )
                , ( bp::arg("eventTimeDelta"), bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::OrbitManipulator::rotateTrackball
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "rotateTrackball"
                , rotateTrackball_function_type( &MultiTouchTrackballManipulator_wrapper::default_rotateTrackball )
        ...
        { //::osgGA::OrbitManipulator::rotateWithFixedVertical
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , rotateWithFixedVertical_function_type( &MultiTouchTrackballManipulator_wrapper::default_rotateWithFixedVertical )
                , ( bp::arg("dx"), bp::arg("dy") ) );
        ...
        { //::osgGA::StandardManipulator::rotateYawPitch
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "rotateYawPitch"
                , rotateYawPitch_function_type( &MultiTouchTrackballManipulator_wrapper::rotateYawPitch )
        ...
        { //::osgGA::StandardManipulator::setAllowThrow
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setAllowThrow_function_type(&MultiTouchTrackballManipulator_wrapper::default_setAllowThrow)
                , ( bp::arg("allowThrow") ) );
        ...
        { //::osgGA::StandardManipulator::setAnimationTime
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setAnimationTime_function_type(&MultiTouchTrackballManipulator_wrapper::default_setAnimationTime)
                , ( bp::arg("t") ) );
        ...
        { //::osgGA::CameraManipulator::setAutoComputeHomePosition
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setAutoComputeHomePosition_function_type(&MultiTouchTrackballManipulator_wrapper::default_setAutoComputeHomePosition)
                , ( bp::arg("flag") ) );
        ...
        { //::osgGA::OrbitManipulator::setByInverseMatrix
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setByInverseMatrix_function_type(&MultiTouchTrackballManipulator_wrapper::default_setByInverseMatrix)
                , ( bp::arg("matrix") ) );
        ...
        { //::osgGA::OrbitManipulator::setByMatrix
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setByMatrix_function_type(&MultiTouchTrackballManipulator_wrapper::default_setByMatrix)
                , ( bp::arg("matrix") ) );
        ...
        { //::osgGA::OrbitManipulator::setCenter
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setCenter_function_type(&MultiTouchTrackballManipulator_wrapper::default_setCenter)
                , ( bp::arg("center") ) );
        ...
        { //::osgGA::CameraManipulator::setCoordinateFrameCallback
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setCoordinateFrameCallback_function_type(&MultiTouchTrackballManipulator_wrapper::default_setCoordinateFrameCallback)
                , ( bp::arg("cb") ) );
        ...
        { //::osgGA::OrbitManipulator::setDistance
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setDistance_function_type(&MultiTouchTrackballManipulator_wrapper::default_setDistance)
                , ( bp::arg("distance") ) );
        ...
        { //::osgGA::CameraManipulator::setHomePosition
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setHomePosition_function_type(&MultiTouchTrackballManipulator_wrapper::default_setHomePosition)
        ...
        { //::osgGA::OrbitManipulator::setMinimumDistance
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setMinimumDistance_function_type(&MultiTouchTrackballManipulator_wrapper::default_setMinimumDistance)
        ...
        { //::osgGA::StandardManipulator::setNode
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setNode_function_type(&MultiTouchTrackballManipulator_wrapper::default_setNode)
                , ( bp::arg("arg0") ) );
        ...
        { //::osgGA::StandardManipulator::setRelativeFlag
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "setRelativeFlag"
                , setRelativeFlag_function_type( &MultiTouchTrackballManipulator_wrapper::setRelativeFlag )
        ...
        { //::osgGA::OrbitManipulator::setRotation
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setRotation_function_type(&MultiTouchTrackballManipulator_wrapper::default_setRotation)
                , ( bp::arg("rotation") ) );
        ...
        { //::osgGA::OrbitManipulator::setTrackballSize
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setTrackballSize_function_type(&MultiTouchTrackballManipulator_wrapper::default_setTrackballSize)
                , ( bp::arg("size") ) );
        ...
        { //::osgGA::OrbitManipulator::setTransformation
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setTransformation_function_type(&MultiTouchTrackballManipulator_wrapper::default_setTransformation)
                , ( bp::arg("eye"), bp::arg("rotation") ) );
        ...
        { //::osgGA::StandardManipulator::setVerticalAxisFixed
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setVerticalAxisFixed_function_type(&MultiTouchTrackballManipulator_wrapper::default_setVerticalAxisFixed)
                , ( bp::arg("value") ) );
        ...
        { //::osgGA::OrbitManipulator::setWheelZoomFactor
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_setWheelZoomFactor_function_type(&MultiTouchTrackballManipulator_wrapper::default_setWheelZoomFactor)
        ...
        { //::osgGA::OrbitManipulator::tb_project_to_sphere
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , tb_project_to_sphere_function_type( &MultiTouchTrackballManipulator_wrapper::tb_project_to_sphere )
        ...
        { //::osgGA::OrbitManipulator::trackball
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "trackball"
                , trackball_function_type( &MultiTouchTrackballManipulator_wrapper::trackball )
        ...
        { //::osgGA::CameraManipulator::updateCamera
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                ...
                , default_updateCamera_function_type(&MultiTouchTrackballManipulator_wrapper::default_updateCamera)
                , ( bp::arg("camera") ) );
        ...
        { //::osgGA::OrbitManipulator::zoomModel
            ...
            MultiTouchTrackballManipulator_exposer.def( 
                "zoomModel"
                , zoomModel_function_type( &MultiTouchTrackballManipulator_wrapper::default_zoomModel )
                , ( bp::arg("dy"), bp::arg("pushForwardIfNeeded")=(bool)(true) ) );
        
        }
        MultiTouchTrackballManipulator_exposer.staticmethod( "allocateRelativeFlag" );
        MultiTouchTrackballManipulator_exposer.staticmethod( "fixVerticalAxis" );
        MultiTouchTrackballManipulator_exposer.staticmethod( "rotateYawPitch" );
    }
