...
struct Uniform_wrapper : osg::Uniform, bp::wrapper< osg::Uniform > {
    ...
    struct Callback_wrapper : osg::Uniform::Callback, bp::wrapper< osg::Uniform::Callback > {
        ...
        Callback_wrapper(::osg::Uniform::Callback const & arg0, ::osg::CopyOp const & arg1 )
        : osg::Uniform::Callback( boost::ref(arg0), boost::ref(arg1) )
          , bp::wrapper< osg::Uniform::Callback >(){
            // constructor
    ...
    Uniform_wrapper(::osg::Uniform const & rhs, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::Uniform( boost::ref(rhs), boost::ref(copyop) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, float f )
    : osg::Uniform( name, f )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, double d )
    : osg::Uniform( name, d )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, int i )
    : osg::Uniform( name, i )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, unsigned int ui )
    : osg::Uniform( name, ui )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, bool b )
    : osg::Uniform( name, b )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Vec2 const & v2 )
    : osg::Uniform( name, boost::ref(v2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Vec3 const & v3 )
    : osg::Uniform( name, boost::ref(v3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Vec4 const & v4 )
    : osg::Uniform( name, boost::ref(v4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Vec2d const & v2 )
    : osg::Uniform( name, boost::ref(v2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Vec3d const & v3 )
    : osg::Uniform( name, boost::ref(v3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Vec4d const & v4 )
    : osg::Uniform( name, boost::ref(v4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix2 const & m2 )
    : osg::Uniform( name, boost::ref(m2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix3 const & m3 )
    : osg::Uniform( name, boost::ref(m3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrixf const & m4 )
    : osg::Uniform( name, boost::ref(m4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix2x3 const & m2x3 )
    : osg::Uniform( name, boost::ref(m2x3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix2x4 const & m2x4 )
    : osg::Uniform( name, boost::ref(m2x4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix3x2 const & m3x2 )
    : osg::Uniform( name, boost::ref(m3x2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix3x4 const & m3x4 )
    : osg::Uniform( name, boost::ref(m3x4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix4x2 const & m4x2 )
    : osg::Uniform( name, boost::ref(m4x2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix4x3 const & m4x3 )
    : osg::Uniform( name, boost::ref(m4x3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    
    }

    Uniform_wrapper(char const * name, ::osg::Matrix2d const & m2 )
    : osg::Uniform( name, boost::ref(m2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix3d const & m3 )
    : osg::Uniform( name, boost::ref(m3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrixd const & m4 )
    : osg::Uniform( name, boost::ref(m4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix2x3d const & m2x3 )
    : osg::Uniform( name, boost::ref(m2x3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix2x4d const & m2x4 )
    : osg::Uniform( name, boost::ref(m2x4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix3x2d const & m3x2 )
    : osg::Uniform( name, boost::ref(m3x2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix3x4d const & m3x4 )
    : osg::Uniform( name, boost::ref(m3x4) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix4x2d const & m4x2 )
    : osg::Uniform( name, boost::ref(m4x2) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    Uniform_wrapper(char const * name, ::osg::Matrix4x3d const & m4x3 )
    : osg::Uniform( name, boost::ref(m4x3) )
      , bp::wrapper< osg::Uniform >(){
        // constructor
    ...
    virtual int compare( ::osg::Uniform const & rhs ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            return func_compare( boost::ref(rhs) );
        else{
            return this->osg::Uniform::compare( boost::ref(rhs) );
        }
    }
    
    int default_compare( ::osg::Uniform const & rhs ) const  {
        return osg::Uniform::compare( boost::ref(rhs) );
    }

    virtual int compareData( ::osg::Uniform const & rhs ) const  {
        if( bp::override func_compareData = this->get_override( "compareData" ) )
            return func_compareData( boost::ref(rhs) );
        else{
            return this->osg::Uniform::compareData( boost::ref(rhs) );
        }
    }
    
    int default_compareData( ::osg::Uniform const & rhs ) const  {
        return osg::Uniform::compareData( boost::ref(rhs) );
    }
...
void register_Uniform_class(){
    ...
    { //::osg::Uniform
        typedef bp::class_< Uniform_wrapper, bp::bases< osg::Object >, boost::noncopyable > Uniform_exposer_t;
        ...
        bp::enum_< osg::Uniform::Type>("Type")
            ...
            .export_values()
            ;
        bp::class_< Uniform_wrapper::Callback_wrapper, bp::bases< osg::Object >, boost::noncopyable >( "Callback", bp::init< >() )    
            .def( bp::init< osg::Uniform::Callback const &, osg::CopyOp const & >(( bp::arg("arg0"), bp::arg("arg1") )) )    
            .def( 
                "className"
        ...
        Uniform_exposer.def( bp::init< osg::Uniform const &, bp::optional< osg::CopyOp const & > >(( bp::arg("rhs"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::Uniform const &, osg::Uniform >();
        Uniform_exposer.def( bp::init< char const *, float >(( bp::arg("name"), bp::arg("f") )) );
        Uniform_exposer.def( bp::init< char const *, double >(( bp::arg("name"), bp::arg("d") )) );
        Uniform_exposer.def( bp::init< char const *, int >(( bp::arg("name"), bp::arg("i") )) );
        Uniform_exposer.def( bp::init< char const *, unsigned int >(( bp::arg("name"), bp::arg("ui") )) );
        Uniform_exposer.def( bp::init< char const *, bool >(( bp::arg("name"), bp::arg("b") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Vec2 const & >(( bp::arg("name"), bp::arg("v2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Vec3 const & >(( bp::arg("name"), bp::arg("v3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Vec4 const & >(( bp::arg("name"), bp::arg("v4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Vec2d const & >(( bp::arg("name"), bp::arg("v2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Vec3d const & >(( bp::arg("name"), bp::arg("v3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Vec4d const & >(( bp::arg("name"), bp::arg("v4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix2 const & >(( bp::arg("name"), bp::arg("m2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix3 const & >(( bp::arg("name"), bp::arg("m3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrixf const & >(( bp::arg("name"), bp::arg("m4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix2x3 const & >(( bp::arg("name"), bp::arg("m2x3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix2x4 const & >(( bp::arg("name"), bp::arg("m2x4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix3x2 const & >(( bp::arg("name"), bp::arg("m3x2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix3x4 const & >(( bp::arg("name"), bp::arg("m3x4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix4x2 const & >(( bp::arg("name"), bp::arg("m4x2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix4x3 const & >(( bp::arg("name"), bp::arg("m4x3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix2d const & >(( bp::arg("name"), bp::arg("m2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix3d const & >(( bp::arg("name"), bp::arg("m3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrixd const & >(( bp::arg("name"), bp::arg("m4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix2x3d const & >(( bp::arg("name"), bp::arg("m2x3") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix2x4d const & >(( bp::arg("name"), bp::arg("m2x4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix3x2d const & >(( bp::arg("name"), bp::arg("m3x2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix3x4d const & >(( bp::arg("name"), bp::arg("m3x4") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix4x2d const & >(( bp::arg("name"), bp::arg("m4x2") )) );
        Uniform_exposer.def( bp::init< char const *, osg::Matrix4x3d const & >(( bp::arg("name"), bp::arg("m4x3") )) );
        ...
        { //::osg::Uniform::compare
            ...
            typedef int ( ::osg::Uniform::*compare_function_type)( ::osg::Uniform const & ) const;
            typedef int ( Uniform_wrapper::*default_compare_function_type)( ::osg::Uniform const & ) const;
            
            Uniform_exposer.def( 
                "compare"
                , compare_function_type(&::osg::Uniform::compare)
                , default_compare_function_type(&Uniform_wrapper::default_compare)
                , ( bp::arg("rhs") ) );
        
        }
        { //::osg::Uniform::compareData
        
            typedef int ( ::osg::Uniform::*compareData_function_type)( ::osg::Uniform const & ) const;
            typedef int ( Uniform_wrapper::*default_compareData_function_type)( ::osg::Uniform const & ) const;
            
            Uniform_exposer.def( 
                "compareData"
                , compareData_function_type(&::osg::Uniform::compareData)
                , default_compareData_function_type(&Uniform_wrapper::default_compareData)
                , ( bp::arg("rhs") ) );
        
        }
        { //::osg::Uniform::copyData
        
            typedef void ( ::osg::Uniform::*copyData_function_type)( ::osg::Uniform const & ) ;
            
            Uniform_exposer.def( 
                "copyData"
                , copyData_function_type( &::osg::Uniform::copyData )
                , ( bp::arg("rhs") ) );
        ...
        Uniform_exposer.def( bp::self != bp::self );
        Uniform_exposer.def( bp::self < bp::self );
        Uniform_exposer.def( bp::self == bp::self );
        { //::osg::Uniform::set
