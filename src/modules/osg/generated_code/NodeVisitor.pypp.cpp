...
void register_NodeVisitor_class(){
    ...
    { //::osg::NodeVisitor
        ...
        bp::enum_< osg::NodeVisitor::VisitorType>("VisitorType")
            ...
            .export_values()
            ;
        bp::class_< NodeVisitor_wrapper::DatabaseRequestHandler_wrapper, bp::bases< osg::Referenced >, osg::ref_ptr< ::osg::NodeVisitor::DatabaseRequestHandler >, boost::noncopyable >( "DatabaseRequestHandler", bp::no_init )    
            .def( 
                "requestNodeFile"
            ...
            .def( 
                ...
                , ( bp::arg("threadSafe") ) );
        bp::class_< NodeVisitor_wrapper::ImageRequestHandler_wrapper, bp::bases< osg::Referenced >, osg::ref_ptr< ::osg::NodeVisitor::ImageRequestHandler >, boost::noncopyable >( "ImageRequestHandler", bp::no_init )    
            .def( 
                "getPreLoadTime"
