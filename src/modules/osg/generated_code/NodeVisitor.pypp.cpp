...
void register_NodeVisitor_class(){
    ...
    { //::osg::NodeVisitor
        ...
        bp::enum_< osg::NodeVisitor::VisitorType>("VisitorType")
            ...
            .export_values()
            ;
        bp::class_< NodeVisitor_wrapper::DatabaseRequestHandler_wrapper, bp::bases< osg::Referenced >, osg::ref_ptr< NodeVisitor_wrapper::DatabaseRequestHandler_wrapper >, boost::noncopyable >( "DatabaseRequestHandler", "\n Callback for managing database paging, such as generated by PagedLOD nodes.\n", bp::no_init )    
            .def( 
                "requestNodeFile"
            ...
            .def( 
                ...
                , ( bp::arg("threadSafe") ) );
        bp::class_< NodeVisitor_wrapper::ImageRequestHandler_wrapper, bp::bases< osg::Referenced >, osg::ref_ptr< NodeVisitor_wrapper::ImageRequestHandler_wrapper >, boost::noncopyable >( "ImageRequestHandler", "\n Callback for managing image paging, such as generated by PagedLOD nodes.\n", bp::no_init )    
            .def( 
                "getPreLoadTime"
