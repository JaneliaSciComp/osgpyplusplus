...
struct FragmentProgram_wrapper : osg::FragmentProgram, bp::wrapper< osg::FragmentProgram > {
    ...
    struct Extensions_wrapper : osg::FragmentProgram::Extensions, bp::wrapper< osg::FragmentProgram::Extensions > {
        ...
        Extensions_wrapper(::osg::FragmentProgram::Extensions const & rhs )
        : osg::FragmentProgram::Extensions( boost::ref(rhs) )
          , bp::wrapper< osg::FragmentProgram::Extensions >(){
            // copy constructor
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::FragmentProgram::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::FragmentProgram::compare( boost::ref(sa) );
    }
...
void register_FragmentProgram_class(){
    ...
    { //::osg::FragmentProgram
        ...
        { //::osg::FragmentProgram::Extensions
            ...
            Extensions_exposer.def( bp::init< osg::FragmentProgram::Extensions const & >(( bp::arg("rhs") )) );
            ...
            { //::osg::FragmentProgram::Extensions::lowestCommonDenominator
                ...
                typedef void ( ::osg::FragmentProgram::Extensions::*lowestCommonDenominator_function_type)( ::osg::FragmentProgram::Extensions const & ) ;
                
                Extensions_exposer.def( 
                    "lowestCommonDenominator"
                    , lowestCommonDenominator_function_type( &::osg::FragmentProgram::Extensions::lowestCommonDenominator )
                    , ( bp::arg("rhs") ) );
        ...
        { //::osg::FragmentProgram::compare
        
            typedef int ( ::osg::FragmentProgram::*compare_function_type)( ::osg::StateAttribute const & ) const;
            typedef int ( FragmentProgram_wrapper::*default_compare_function_type)( ::osg::StateAttribute const & ) const;
            
            FragmentProgram_exposer.def( 
                "compare"
                , compare_function_type(&::osg::FragmentProgram::compare)
                , default_compare_function_type(&FragmentProgram_wrapper::default_compare)
                , ( bp::arg("sa") ) );
