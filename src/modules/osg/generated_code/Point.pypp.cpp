...
struct Point_wrapper : osg::Point, bp::wrapper< osg::Point > {
    ...
    struct Extensions_wrapper : osg::Point::Extensions, bp::wrapper< osg::Point::Extensions > {
        ...
        Extensions_wrapper(::osg::Point::Extensions const & rhs )
        : osg::Point::Extensions( boost::ref(rhs) )
          , bp::wrapper< osg::Point::Extensions >(){
            // copy constructor
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::Point::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::Point::compare( boost::ref(sa) );
    }
...
void register_Point_class(){
    ...
    { //::osg::Point
        ...
        { //::osg::Point::Extensions
            ...
            Extensions_exposer.def( bp::init< osg::Point::Extensions const & >(( bp::arg("rhs") )) );
            ...
            { //::osg::Point::Extensions::lowestCommonDenominator
                ...
                typedef void ( ::osg::Point::Extensions::*lowestCommonDenominator_function_type)( ::osg::Point::Extensions const & ) ;
                
                Extensions_exposer.def( 
                    "lowestCommonDenominator"
                    , lowestCommonDenominator_function_type( &::osg::Point::Extensions::lowestCommonDenominator )
                    , ( bp::arg("rhs") ) );
        ...
        { //::osg::Point::compare
            ...
            typedef int ( ::osg::Point::*compare_function_type)( ::osg::StateAttribute const & ) const;
            typedef int ( Point_wrapper::*default_compare_function_type)( ::osg::StateAttribute const & ) const;
            
            Point_exposer.def( 
                "compare"
                , compare_function_type(&::osg::Point::compare)
                , default_compare_function_type(&Point_wrapper::default_compare)
                , ( bp::arg("sa") ) );
