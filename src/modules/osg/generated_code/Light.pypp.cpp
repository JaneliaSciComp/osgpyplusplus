...
struct Light_wrapper : osg::Light, bp::wrapper< osg::Light > {
    ...
    Light_wrapper(::osg::Light const & light, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::Light( boost::ref(light), boost::ref(copyop) )
      , bp::wrapper< osg::Light >(){
        // constructor
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::Light::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::Light::compare( boost::ref(sa) );
    }
...
void register_Light_class(){
    ...
    { //::osg::Light
        typedef bp::class_< Light_wrapper, bp::bases< osg::StateAttribute >, boost::noncopyable > Light_exposer_t;
        ...
        Light_exposer.def( bp::init< osg::Light const &, bp::optional< osg::CopyOp const & > >(( bp::arg("light"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::Light const &, osg::Light >();
        { //::osg::Light::apply
        ...
        { //::osg::Light::compare
            ...
            typedef int ( ::osg::Light::*compare_function_type)( ::osg::StateAttribute const & ) const;
            typedef int ( Light_wrapper::*default_compare_function_type)( ::osg::StateAttribute const & ) const;
            
            Light_exposer.def( 
                "compare"
                , compare_function_type(&::osg::Light::compare)
                , default_compare_function_type(&Light_wrapper::default_compare)
                , ( bp::arg("sa") ) );
        ...
        { //::osg::StateAttribute::releaseGLObjects
            ...
            typedef void ( Light_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            Light_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::StateAttribute::releaseGLObjects)
                , default_releaseGLObjects_function_type(&Light_wrapper::default_releaseGLObjects)
