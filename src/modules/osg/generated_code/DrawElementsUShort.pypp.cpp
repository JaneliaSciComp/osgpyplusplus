...
struct DrawElementsUShort_wrapper : osg::DrawElementsUShort, bp::wrapper< osg::DrawElementsUShort > {
    ...
    DrawElementsUShort_wrapper(::osg::DrawElementsUShort const & array, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::DrawElementsUShort( boost::ref(array), boost::ref(copyop) )
      , bp::wrapper< osg::DrawElementsUShort >(){
        // constructor
...
void register_DrawElementsUShort_class(){
    ...
    { //::osg::DrawElementsUShort
        typedef bp::class_< DrawElementsUShort_wrapper, bp::bases< osg::DrawElements, osg::MixinVector< unsigned short > >, boost::noncopyable > DrawElementsUShort_exposer_t;
        ...
        DrawElementsUShort_exposer.def( bp::init< osg::DrawElementsUShort const &, bp::optional< osg::CopyOp const & > >(( bp::arg("array"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::DrawElementsUShort const &, osg::DrawElementsUShort >();
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( DrawElementsUShort_wrapper::*default_asImage_function_type)(  ) ;
            
            DrawElementsUShort_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&DrawElementsUShort_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( DrawElementsUShort_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( DrawElementsUShort_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            DrawElementsUShort_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&DrawElementsUShort_wrapper::default_releaseGLObjects)
