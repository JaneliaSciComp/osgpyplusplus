...
struct DrawElementsUByte_wrapper : osg::DrawElementsUByte, bp::wrapper< osg::DrawElementsUByte > {
    ...
    DrawElementsUByte_wrapper(::osg::DrawElementsUByte const & array, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::DrawElementsUByte( boost::ref(array), boost::ref(copyop) )
      , bp::wrapper< osg::DrawElementsUByte >(){
        // constructor
...
void register_DrawElementsUByte_class(){
    ...
    { //::osg::DrawElementsUByte
        typedef bp::class_< DrawElementsUByte_wrapper, bp::bases< osg::DrawElements, osg::MixinVector< unsigned char > >, boost::noncopyable > DrawElementsUByte_exposer_t;
        ...
        DrawElementsUByte_exposer.def( bp::init< osg::DrawElementsUByte const &, bp::optional< osg::CopyOp const & > >(( bp::arg("array"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::DrawElementsUByte const &, osg::DrawElementsUByte >();
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( DrawElementsUByte_wrapper::*default_asImage_function_type)(  ) ;
            
            DrawElementsUByte_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&DrawElementsUByte_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( DrawElementsUByte_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( DrawElementsUByte_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            DrawElementsUByte_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&DrawElementsUByte_wrapper::default_releaseGLObjects)
