...
struct BufferData_wrapper : osg::BufferData, bp::wrapper< osg::BufferData > {
    ...
    struct ModifiedCallback_wrapper : osg::BufferData::ModifiedCallback, bp::wrapper< osg::BufferData::ModifiedCallback > {
        ...
        ModifiedCallback_wrapper(::osg::BufferData::ModifiedCallback const & arg0, ::osg::CopyOp const & arg1 )
        : osg::BufferData::ModifiedCallback( boost::ref(arg0), boost::ref(arg1) )
          , bp::wrapper< osg::BufferData::ModifiedCallback >(){
            // constructor
    ...
    BufferData_wrapper(::osg::BufferData const & bd, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::BufferData( boost::ref(bd), boost::ref(copyop) )
      , bp::wrapper< osg::BufferData >(){
        // constructor
...
void register_BufferData_class(){
    ...
    { //::osg::BufferData
        ...
        bp::class_< BufferData_wrapper::ModifiedCallback_wrapper, bp::bases< osg::Object >, boost::noncopyable >( "ModifiedCallback", bp::init< >() )    
            .def( bp::init< osg::BufferData::ModifiedCallback const &, osg::CopyOp const & >(( bp::arg("arg0"), bp::arg("arg1") )) )    
            .def( 
                "className"
        ...
        BufferData_exposer.def( bp::init< osg::BufferData const &, bp::optional< osg::CopyOp const & > >(( bp::arg("bd"), bp::arg("copyop")=SHALLOW_COPY )) );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( BufferData_wrapper::*default_asImage_function_type)(  ) ;
            
            BufferData_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&BufferData_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( BufferData_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::asPrimitiveSet
            ...
            typedef ::osg::PrimitiveSet * ( BufferData_wrapper::*default_asPrimitiveSet_function_type)(  ) ;
            
            BufferData_exposer.def( 
                "asPrimitiveSet"
                , asPrimitiveSet_function_type(&::osg::BufferData::asPrimitiveSet)
                , default_asPrimitiveSet_function_type(&BufferData_wrapper::default_asPrimitiveSet)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asPrimitiveSet
            ...
            typedef ::osg::PrimitiveSet const * ( BufferData_wrapper::*default_asPrimitiveSet_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( BufferData_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            BufferData_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&BufferData_wrapper::default_releaseGLObjects)
