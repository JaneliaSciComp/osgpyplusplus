...
void register_RefBlockCount_class(){
    ...
    { //::osg::RefBlockCount
        typedef bp::class_< RefBlockCount_wrapper, bp::bases< osg::Referenced, OpenThreads::BlockCount >, osg::ref_ptr< RefBlockCount_wrapper >, boost::noncopyable > RefBlockCount_exposer_t;
