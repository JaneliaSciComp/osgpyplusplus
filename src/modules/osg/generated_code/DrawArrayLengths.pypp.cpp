...
struct DrawArrayLengths_wrapper : osg::DrawArrayLengths, bp::wrapper< osg::DrawArrayLengths > {
    ...
    DrawArrayLengths_wrapper(::osg::DrawArrayLengths const & dal, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::DrawArrayLengths( boost::ref(dal), boost::ref(copyop) )
      , bp::wrapper< osg::DrawArrayLengths >(){
        // constructor
...
void register_DrawArrayLengths_class(){
    ...
    { //::osg::DrawArrayLengths
        typedef bp::class_< DrawArrayLengths_wrapper, bp::bases< osg::PrimitiveSet, osg::MixinVector< int > >, boost::noncopyable > DrawArrayLengths_exposer_t;
        ...
        DrawArrayLengths_exposer.def( bp::init< osg::DrawArrayLengths const &, bp::optional< osg::CopyOp const & > >(( bp::arg("dal"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::DrawArrayLengths const &, osg::DrawArrayLengths >();
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( DrawArrayLengths_wrapper::*default_asImage_function_type)(  ) ;
            
            DrawArrayLengths_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&DrawArrayLengths_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( DrawArrayLengths_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( DrawArrayLengths_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            DrawArrayLengths_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&DrawArrayLengths_wrapper::default_releaseGLObjects)
