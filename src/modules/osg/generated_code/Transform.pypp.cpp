...
struct Transform_wrapper : osg::Transform, bp::wrapper< osg::Transform > {
    ...
    Transform_wrapper(::osg::Transform const & arg0, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::Transform( boost::ref(arg0), boost::ref(copyop) )
      , bp::wrapper< osg::Transform >(){
        // constructor
...
void register_Transform_class(){
    ...
    { //::osg::Transform
        typedef bp::class_< Transform_wrapper, bp::bases< osg::Group >, boost::noncopyable > Transform_exposer_t;
        ...
        Transform_exposer.def( bp::init< osg::Transform const &, bp::optional< osg::CopyOp const & > >(( bp::arg("arg0"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::Transform const &, osg::Transform >();
        ...
        { //::osg::Node::asTerrain
            ...
            typedef ::osgTerrain::Terrain * ( Transform_wrapper::*default_asTerrain_function_type)(  ) ;
            
            Transform_exposer.def( 
                "asTerrain"
                , asTerrain_function_type(&::osg::Node::asTerrain)
                , default_asTerrain_function_type(&Transform_wrapper::default_asTerrain)
                    /* undefined call policies */ );
        ...
        { //::osg::Node::asTerrain
            ...
            typedef ::osgTerrain::Terrain const * ( Transform_wrapper::*default_asTerrain_function_type)(  ) const;
        ...
        { //::osg::Group::releaseGLObjects
            ...
            typedef void ( Transform_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            Transform_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::Group::releaseGLObjects)
                , default_releaseGLObjects_function_type(&Transform_wrapper::default_releaseGLObjects)
