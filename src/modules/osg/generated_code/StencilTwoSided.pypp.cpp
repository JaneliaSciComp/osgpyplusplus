...
struct StencilTwoSided_wrapper : osg::StencilTwoSided, bp::wrapper< osg::StencilTwoSided > {
    ...
    struct Extensions_wrapper : osg::StencilTwoSided::Extensions, bp::wrapper< osg::StencilTwoSided::Extensions > {
        ...
        Extensions_wrapper(::osg::StencilTwoSided::Extensions const & rhs )
        : osg::StencilTwoSided::Extensions( boost::ref(rhs) )
          , bp::wrapper< osg::StencilTwoSided::Extensions >(){
            // copy constructor
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::StencilTwoSided::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::StencilTwoSided::compare( boost::ref(sa) );
    }
...
void register_StencilTwoSided_class(){
    ...
    { //::osg::StencilTwoSided
        ...
        { //::osg::StencilTwoSided::Extensions
            ...
            Extensions_exposer.def( bp::init< osg::StencilTwoSided::Extensions const & >(( bp::arg("rhs") )) );
            ...
            { //::osg::StencilTwoSided::Extensions::lowestCommonDenominator
                ...
                typedef void ( ::osg::StencilTwoSided::Extensions::*lowestCommonDenominator_function_type)( ::osg::StencilTwoSided::Extensions const & ) ;
                
                Extensions_exposer.def( 
                    "lowestCommonDenominator"
                    , lowestCommonDenominator_function_type( &::osg::StencilTwoSided::Extensions::lowestCommonDenominator )
                    , ( bp::arg("rhs") ) );
        ...
        { //::osg::StencilTwoSided::compare
        
            typedef int ( ::osg::StencilTwoSided::*compare_function_type)( ::osg::StateAttribute const & ) const;
            typedef int ( StencilTwoSided_wrapper::*default_compare_function_type)( ::osg::StateAttribute const & ) const;
            
            StencilTwoSided_exposer.def( 
                "compare"
                , compare_function_type(&::osg::StencilTwoSided::compare)
                , default_compare_function_type(&StencilTwoSided_wrapper::default_compare)
                , ( bp::arg("sa") ) );
