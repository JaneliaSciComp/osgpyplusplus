...
void register_ShadowVolumeOccluder_class(){
    ...
    bp::class_< osg::ShadowVolumeOccluder >( "ShadowVolumeOccluder", "\n ShadowVolumeOccluder is a helper class for implementing shadow occlusion culling.\n", bp::init< osg::ShadowVolumeOccluder const & >(( bp::arg("svo") )) )    
        ...
        .def( 
            "computeOccluder"
            , (bool ( ::osg::ShadowVolumeOccluder::* )( ::osg::NodePath const &,::osg::ConvexPlanarOccluder const &,::osg::CullStack &,bool ))( &::osg::ShadowVolumeOccluder::computeOccluder )
            , ( bp::arg("nodePath"), bp::arg("occluder"), bp::arg("cullStack"), bp::arg("createDrawables")=(bool)(false) )
