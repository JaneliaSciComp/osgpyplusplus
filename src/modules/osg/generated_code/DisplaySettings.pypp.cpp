...
struct DisplaySettings_wrapper : osg::DisplaySettings, bp::wrapper< osg::DisplaySettings > {
    ...
    DisplaySettings_wrapper( )
    : osg::DisplaySettings( )
      , bp::wrapper< osg::DisplaySettings >(){
        // null constructor
    
    }

    DisplaySettings_wrapper(::osg::ArgumentParser & arguments )
    : osg::DisplaySettings( boost::ref(arguments) )
      , bp::wrapper< osg::DisplaySettings >(){
        // constructor
    
    }

    DisplaySettings_wrapper(::osg::DisplaySettings const & vs )
    : osg::DisplaySettings( boost::ref(vs) )
      , bp::wrapper< osg::DisplaySettings >(){
        // copy constructor
...
void register_DisplaySettings_class(){
    ...
    { //::osg::DisplaySettings
        typedef bp::class_< DisplaySettings_wrapper, bp::bases< osg::Referenced > > DisplaySettings_exposer_t;
        ...
        bp::enum_< osg::DisplaySettings::SwapMethod>("SwapMethod")
            ...
            .export_values()
            ;
        DisplaySettings_exposer.def( bp::init< >() );
        DisplaySettings_exposer.def( bp::init< osg::ArgumentParser & >(( bp::arg("arguments") )) );
        bp::implicitly_convertible< osg::ArgumentParser &, osg::DisplaySettings >();
        DisplaySettings_exposer.def( bp::init< osg::DisplaySettings const & >(( bp::arg("vs") )) );
        ...
        { //::osg::DisplaySettings::merge
        
            typedef void ( ::osg::DisplaySettings::*merge_function_type)( ::osg::DisplaySettings const & ) ;
            
            DisplaySettings_exposer.def( 
                "merge"
                , merge_function_type( &::osg::DisplaySettings::merge )
                , ( bp::arg("vs") ) );
        
        }
        { //::osg::DisplaySettings::operator=
        
            typedef ::osg::DisplaySettings & ( ::osg::DisplaySettings::*assign_function_type)( ::osg::DisplaySettings const & ) ;
            
            DisplaySettings_exposer.def( 
                "assign"
                , assign_function_type( &::osg::DisplaySettings::operator= )
                , ( bp::arg("vs") )
                , bp::return_self< >() );
        ...
        { //::osg::DisplaySettings::setDisplaySettings
        
            typedef void ( ::osg::DisplaySettings::*setDisplaySettings_function_type)( ::osg::DisplaySettings const & ) ;
            
            DisplaySettings_exposer.def( 
                "setDisplaySettings"
                , setDisplaySettings_function_type( &::osg::DisplaySettings::setDisplaySettings )
                , ( bp::arg("vs") ) );
