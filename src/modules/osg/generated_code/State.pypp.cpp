...
void register_State_class(){
    ...
    { //::osg::State
        typedef bp::class_< State_wrapper, bp::bases< osg::Referenced, osg::Observer >, boost::noncopyable > State_exposer_t;
        ...
        { //::osg::State::getTexCoordAliasList
        
            typedef ::std::vector< osg::VertexAttribAlias > const & ( ::osg::State::*getTexCoordAliasList_function_type)(  ) ;
            
            State_exposer.def( 
                "getTexCoordAliasList"
                , getTexCoordAliasList_function_type( &::osg::State::getTexCoordAliasList )
                , bp::return_internal_reference< >() );
        ...
        { //::osg::State::setTexCoordAliasList
        
            typedef void ( ::osg::State::*setTexCoordAliasList_function_type)( ::std::vector< osg::VertexAttribAlias > const & ) ;
            
            State_exposer.def( 
                "setTexCoordAliasList"
                , setTexCoordAliasList_function_type( &::osg::State::setTexCoordAliasList )
                , ( bp::arg("aliasList") ) );
