...
struct RefMatrixf_wrapper : osg::RefMatrixf, bp::wrapper< osg::RefMatrixf > {
    ...
    RefMatrixf_wrapper(::osg::RefMatrixf const & other )
    : osg::RefMatrixf( boost::ref(other) )
      , bp::wrapper< osg::RefMatrixf >(){
        // copy constructor
...
void register_RefMatrixf_class(){
    ...
    { //::osg::RefMatrixf
        typedef bp::class_< RefMatrixf_wrapper, bp::bases< osg::Object, osg::Matrixf > > RefMatrixf_exposer_t;
        ...
        RefMatrixf_exposer.def( bp::init< osg::RefMatrixf const & >(( bp::arg("other") )) );
