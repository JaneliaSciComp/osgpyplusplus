...
struct ColorMatrix_wrapper : osg::ColorMatrix, bp::wrapper< osg::ColorMatrix > {
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::ColorMatrix::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::ColorMatrix::compare( boost::ref(sa) );
    }
...
void register_ColorMatrix_class(){
    ...
    bp::class_< ColorMatrix_wrapper, bp::bases< osg::StateAttribute >, osg::ref_ptr< ::osg::ColorMatrix >, boost::noncopyable >( "ColorMatrix", "\n Encapsulates OpenGL color matrix functionality.\n", bp::no_init )    
        ...
        .def( 
            "compare"
            , (int ( ::osg::ColorMatrix::* )( ::osg::StateAttribute const & )const)(&::osg::ColorMatrix::compare)
            , (int ( ColorMatrix_wrapper::* )( ::osg::StateAttribute const & )const)(&ColorMatrix_wrapper::default_compare)
            , ( bp::arg("sa") ) )    
        .def( 
            "getMatrix"
