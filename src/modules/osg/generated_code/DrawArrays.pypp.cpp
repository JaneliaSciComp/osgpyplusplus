...
struct DrawArrays_wrapper : osg::DrawArrays, bp::wrapper< osg::DrawArrays > {
    ...
    DrawArrays_wrapper(::osg::DrawArrays const & da, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::DrawArrays( boost::ref(da), boost::ref(copyop) )
      , bp::wrapper< osg::DrawArrays >(){
        // constructor
...
void register_DrawArrays_class(){
    ...
    { //::osg::DrawArrays
        typedef bp::class_< DrawArrays_wrapper, bp::bases< osg::PrimitiveSet >, boost::noncopyable > DrawArrays_exposer_t;
        ...
        DrawArrays_exposer.def( bp::init< osg::DrawArrays const &, bp::optional< osg::CopyOp const & > >(( bp::arg("da"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::DrawArrays const &, osg::DrawArrays >();
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( DrawArrays_wrapper::*default_asImage_function_type)(  ) ;
            
            DrawArrays_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&DrawArrays_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( DrawArrays_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( DrawArrays_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            DrawArrays_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&DrawArrays_wrapper::default_releaseGLObjects)
