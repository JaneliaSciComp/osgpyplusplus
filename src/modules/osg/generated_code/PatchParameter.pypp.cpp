...
struct PatchParameter_wrapper : osg::PatchParameter, bp::wrapper< osg::PatchParameter > {
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::PatchParameter::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::PatchParameter::compare( boost::ref(sa) );
    }
...
void register_PatchParameter_class(){
    ...
    { //::osg::PatchParameter
        ...
        { //::osg::PatchParameter::compare
        
            typedef int ( ::osg::PatchParameter::*compare_function_type)( ::osg::StateAttribute const & ) const;
            typedef int ( PatchParameter_wrapper::*default_compare_function_type)( ::osg::StateAttribute const & ) const;
            
            PatchParameter_exposer.def( 
                "compare"
                , compare_function_type(&::osg::PatchParameter::compare)
                , default_compare_function_type(&PatchParameter_wrapper::default_compare)
                , ( bp::arg("sa") ) );
