...
void register_EndOfDynamicDrawBlock_class(){
    ...
    { //::osg::EndOfDynamicDrawBlock
        typedef bp::class_< EndOfDynamicDrawBlock_wrapper, bp::bases< OpenThreads::BlockCount, osg::State::DynamicObjectRenderingCompletedCallback >, boost::noncopyable > EndOfDynamicDrawBlock_exposer_t;
