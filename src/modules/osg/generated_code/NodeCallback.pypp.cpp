...
struct NodeCallback_wrapper : osg::NodeCallback, bp::wrapper< osg::NodeCallback > {
    ...
    NodeCallback_wrapper(::osg::NodeCallback const & nc, ::osg::CopyOp const & arg1 )
    : osg::NodeCallback( boost::ref(nc), boost::ref(arg1) )
      , bp::wrapper< osg::NodeCallback >(){
        // constructor
...
void register_NodeCallback_class(){
    ...
    bp::class_< NodeCallback_wrapper, bp::bases< osg::Object >, boost::noncopyable >( "NodeCallback", bp::no_init )    
        .def( bp::init< >() )    
        .def( bp::init< osg::NodeCallback const &, osg::CopyOp const & >(( bp::arg("nc"), bp::arg("arg1") )) )    
        .def( 
            "addNestedCallback"
