...
struct DrawElementsUInt_wrapper : osg::DrawElementsUInt, bp::wrapper< osg::DrawElementsUInt > {
    ...
    DrawElementsUInt_wrapper(::osg::DrawElementsUInt const & array, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::DrawElementsUInt( boost::ref(array), boost::ref(copyop) )
      , bp::wrapper< osg::DrawElementsUInt >(){
        // constructor
...
void register_DrawElementsUInt_class(){
    ...
    { //::osg::DrawElementsUInt
        typedef bp::class_< DrawElementsUInt_wrapper, bp::bases< osg::DrawElements, osg::MixinVector< unsigned int > >, boost::noncopyable > DrawElementsUInt_exposer_t;
        ...
        DrawElementsUInt_exposer.def( bp::init< osg::DrawElementsUInt const &, bp::optional< osg::CopyOp const & > >(( bp::arg("array"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::DrawElementsUInt const &, osg::DrawElementsUInt >();
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( DrawElementsUInt_wrapper::*default_asImage_function_type)(  ) ;
            
            DrawElementsUInt_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&DrawElementsUInt_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( DrawElementsUInt_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( DrawElementsUInt_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            DrawElementsUInt_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&DrawElementsUInt_wrapper::default_releaseGLObjects)
