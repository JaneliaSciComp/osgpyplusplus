...
struct DrawElements_wrapper : osg::DrawElements, bp::wrapper< osg::DrawElements > {
    ...
    DrawElements_wrapper(::osg::PrimitiveSet::Type primType=::osg::PrimitiveSet::PrimitiveType, ::GLenum mode=0, int numInstances=0 )
    : osg::DrawElements( primType, mode, numInstances )
      , bp::wrapper< osg::DrawElements >(){
        // constructor
    
    }

    DrawElements_wrapper(::osg::DrawElements const & copy, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::DrawElements( boost::ref(copy), boost::ref(copyop) )
      , bp::wrapper< osg::DrawElements >(){
        // constructor
...
void register_DrawElements_class(){
    ...
    bp::class_< DrawElements_wrapper, bp::bases< osg::PrimitiveSet >, boost::noncopyable >( "DrawElements", bp::no_init )    
        .def( bp::init< bp::optional< osg::PrimitiveSet::Type, GLenum, int > >(( bp::arg("primType")=::osg::PrimitiveSet::PrimitiveType, bp::arg("mode")=(::GLenum)(0), bp::arg("numInstances")=(int)(0) )) )    
        .def( bp::init< osg::DrawElements const &, bp::optional< osg::CopyOp const & > >(( bp::arg("copy"), bp::arg("copyop")=SHALLOW_COPY )) )    
        .def( 
            "addElement"
        ...
        .def( 
            ...
            , (::osg::Image * ( DrawElements_wrapper::* )(  ))(&DrawElements_wrapper::default_asImage)
                /* undefined call policies */ )    
        .def( 
            "asImage"
            , (::osg::Image const * ( ::osg::BufferData::* )(  )const)(&::osg::BufferData::asImage)
            , (::osg::Image const * ( DrawElements_wrapper::* )(  )const)(&DrawElements_wrapper::default_asImage)
                /* undefined call policies */ )    
        .def( 
            "asPrimitiveSet"
        ...
        .def( 
            ...
            , (void ( DrawElements_wrapper::* )( ::osg::State * )const)(&DrawElements_wrapper::default_releaseGLObjects)
