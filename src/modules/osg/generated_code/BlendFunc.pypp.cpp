...
struct BlendFunc_wrapper : osg::BlendFunc, bp::wrapper< osg::BlendFunc > {
    ...
    struct Extensions_wrapper : osg::BlendFunc::Extensions, bp::wrapper< osg::BlendFunc::Extensions > {
        ...
        Extensions_wrapper(::osg::BlendFunc::Extensions const & rhs )
        : osg::BlendFunc::Extensions( boost::ref(rhs) )
          , bp::wrapper< osg::BlendFunc::Extensions >(){
            // copy constructor
    ...
    virtual int compare( ::osg::StateAttribute const & sa ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            ...
            return this->osg::BlendFunc::compare( boost::ref(sa) );
        }
    }
    
    int default_compare( ::osg::StateAttribute const & sa ) const  {
        return osg::BlendFunc::compare( boost::ref(sa) );
    }
...
void register_BlendFunc_class(){
    ...
    { //::osg::BlendFunc
        ...
        { //::osg::BlendFunc::Extensions
            ...
            Extensions_exposer.def( bp::init< osg::BlendFunc::Extensions const & >(( bp::arg("rhs") )) );
            ...
            { //::osg::BlendFunc::Extensions::lowestCommonDenominator
                ...
                typedef void ( ::osg::BlendFunc::Extensions::*lowestCommonDenominator_function_type)( ::osg::BlendFunc::Extensions const & ) ;
                
                Extensions_exposer.def( 
                    "lowestCommonDenominator"
                    , lowestCommonDenominator_function_type( &::osg::BlendFunc::Extensions::lowestCommonDenominator )
                    , ( bp::arg("rhs") ) );
        ...
        { //::osg::BlendFunc::compare
        
            typedef int ( ::osg::BlendFunc::*compare_function_type)( ::osg::StateAttribute const & ) const;
            typedef int ( BlendFunc_wrapper::*default_compare_function_type)( ::osg::StateAttribute const & ) const;
            
            BlendFunc_exposer.def( 
                "compare"
                , compare_function_type(&::osg::BlendFunc::compare)
                , default_compare_function_type(&BlendFunc_wrapper::default_compare)
                , ( bp::arg("sa") ) );
