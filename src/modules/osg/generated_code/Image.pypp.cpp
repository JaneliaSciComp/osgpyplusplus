...
struct Image_wrapper : osg::Image, bp::wrapper< osg::Image > {
    ...
    Image_wrapper(::osg::Image const & image, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::Image( boost::ref(image), boost::ref(copyop) )
      , bp::wrapper< osg::Image >(){
        // constructor
    ...
    virtual int compare( ::osg::Image const & rhs ) const  {
        if( bp::override func_compare = this->get_override( "compare" ) )
            return func_compare( boost::ref(rhs) );
        else{
            return this->osg::Image::compare( boost::ref(rhs) );
        }
    }
    
    int default_compare( ::osg::Image const & rhs ) const  {
        return osg::Image::compare( boost::ref(rhs) );
    }
...
void register_Image_class(){
    ...
    { //::osg::Image
        typedef bp::class_< Image_wrapper, bp::bases< osg::BufferData >, boost::noncopyable > Image_exposer_t;
        ...
        { //::osg::Image::DataIterator
            ...
            { //::osg::Image::DataIterator::data
            
                typedef unsigned char const * ( ::osg::Image::DataIterator::*data_function_type)(  ) const;
                
                DataIterator_exposer.def( 
                    "data"
                    , data_function_type( &::osg::Image::DataIterator::data )
        ...
        bp::class_< Image_wrapper::DimensionsChangedCallback_wrapper, bp::bases< osg::Referenced >, boost::noncopyable >( "DimensionsChangedCallback", bp::init< >() )    
            ...
            .def( 
                ...
                , ( bp::arg("threadSafe") ) );
        bp::class_< Image_wrapper::UpdateCallback_wrapper, bp::bases< osg::StateAttributeCallback >, boost::noncopyable >( "UpdateCallback" )    
            .def( 
                "__call__"
            ...
            .def( 
                ...
                , (char const * ( Image_wrapper::UpdateCallback_wrapper::* )(  )const)(&Image_wrapper::UpdateCallback_wrapper::default_className) )    
            .def( 
                "clone"
                , (::osg::Object * ( ::osg::StateAttributeCallback::* )( ::osg::CopyOp const & )const)(&::osg::StateAttributeCallback::clone)
                , (::osg::Object * ( Image_wrapper::UpdateCallback_wrapper::* )( ::osg::CopyOp const & )const)(&Image_wrapper::UpdateCallback_wrapper::default_clone)
                , ( bp::arg("copyop") )
                , bp::return_value_policy< bp::reference_existing_object >() )    
            .def( 
                "cloneType"
                , (::osg::Object * ( ::osg::StateAttributeCallback::* )(  )const)(&::osg::StateAttributeCallback::cloneType)
                , (::osg::Object * ( Image_wrapper::UpdateCallback_wrapper::* )(  )const)(&Image_wrapper::UpdateCallback_wrapper::default_cloneType)
                , bp::return_value_policy< bp::reference_existing_object >() )    
            .def( 
                "computeDataVariance"
            ...
            .def( 
                ...
                , (bool ( Image_wrapper::UpdateCallback_wrapper::* )( ::osg::Object const * )const)(&Image_wrapper::UpdateCallback_wrapper::default_isSameKindAs)
                , ( bp::arg("obj") ) )    
            .def( 
                "libraryName"
                , (char const * ( ::osg::StateAttributeCallback::* )(  )const)(&::osg::StateAttributeCallback::libraryName)
                , (char const * ( Image_wrapper::UpdateCallback_wrapper::* )(  )const)(&Image_wrapper::UpdateCallback_wrapper::default_libraryName) )    
            .def( 
        ...
        Image_exposer.def( bp::init< osg::Image const &, bp::optional< osg::CopyOp const & > >(( bp::arg("image"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::Image const &, osg::Image >();
        ...
        { //::osg::Image::compare
            ...
            typedef int ( ::osg::Image::*compare_function_type)( ::osg::Image const & ) const;
            typedef int ( Image_wrapper::*default_compare_function_type)( ::osg::Image const & ) const;
            
            Image_exposer.def( 
                "compare"
                , compare_function_type(&::osg::Image::compare)
                , default_compare_function_type(&Image_wrapper::default_compare)
                , ( bp::arg("rhs") ) );
        ...
        { //::osg::Image::data
            ...
            typedef unsigned char * ( ::osg::Image::*data_function_type)(  ) ;
            
            Image_exposer.def( 
                "data"
                , data_function_type( &::osg::Image::data )
                    /* undefined call policies */ );
        
        }
        { //::osg::Image::data
        
            typedef unsigned char const * ( ::osg::Image::*data_function_type)(  ) const;
        ...
        { //::osg::Image::data
            ...
            typedef unsigned char * ( ::osg::Image::*data_function_type)( unsigned int,unsigned int,unsigned int ) ;
            
            Image_exposer.def( 
                "data"
                , data_function_type( &::osg::Image::data )
                , ( bp::arg("column"), bp::arg("row")=(unsigned int)(0), bp::arg("image")=(unsigned int)(0) )
                    /* undefined call policies */ );
        
        }
        { //::osg::Image::data
        
            typedef unsigned char const * ( ::osg::Image::*data_function_type)( unsigned int,unsigned int,unsigned int ) const;
        ...
        { //::osg::Image::getMipmapData
        
            typedef unsigned char * ( ::osg::Image::*getMipmapData_function_type)( unsigned int ) ;
            
            Image_exposer.def( 
                "getMipmapData"
                , getMipmapData_function_type( &::osg::Image::getMipmapData )
                , ( bp::arg("mipmapLevel") )
                    /* undefined call policies */ );
        ...
        { //::osg::Image::getMipmapData
            ...
            typedef unsigned char const * ( ::osg::Image::*getMipmapData_function_type)( unsigned int ) const;
        ...
        { //::osg::BufferData::asPrimitiveSet
            ...
            typedef ::osg::PrimitiveSet * ( Image_wrapper::*default_asPrimitiveSet_function_type)(  ) ;
            
            Image_exposer.def( 
                "asPrimitiveSet"
                , asPrimitiveSet_function_type(&::osg::BufferData::asPrimitiveSet)
                , default_asPrimitiveSet_function_type(&Image_wrapper::default_asPrimitiveSet)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asPrimitiveSet
            ...
            typedef ::osg::PrimitiveSet const * ( Image_wrapper::*default_asPrimitiveSet_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( Image_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            Image_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&Image_wrapper::default_releaseGLObjects)
