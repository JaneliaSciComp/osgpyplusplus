...
struct Camera_wrapper : osg::Camera, bp::wrapper< osg::Camera > {
    ...
    struct DrawCallback_wrapper : osg::Camera::DrawCallback, bp::wrapper< osg::Camera::DrawCallback > {
        ...
        DrawCallback_wrapper(::osg::Camera::DrawCallback const & arg0, ::osg::CopyOp const & arg1 )
        : osg::Camera::DrawCallback( boost::ref(arg0), boost::ref(arg1) )
          , bp::wrapper< osg::Camera::DrawCallback >(){
            // constructor
        ...
        virtual void operator()( ::osg::Camera const & arg0 ) const  {
            if( bp::override func___call__ = this->get_override( "__call__" ) )
                ...
                this->osg::Camera::DrawCallback::operator()( boost::ref(arg0) );
            }
        }
        
        void default___call__( ::osg::Camera const & arg0 ) const  {
    ...
    Camera_wrapper(::osg::Camera const & arg0, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::Camera( boost::ref(arg0), boost::ref(copyop) )
      , bp::wrapper< osg::Camera >(){
        // constructor
    ...
    virtual void releaseGLObjects( ::osg::State * arg0=0 ) const  {
        if( bp::override func_releaseGLObjects = this->get_override( "releaseGLObjects" ) )
            ...
            this->osg::Camera::releaseGLObjects( boost::python::ptr(arg0) );
        }
    }
    
    void default_releaseGLObjects( ::osg::State * arg0=0 ) const  {
        osg::Camera::releaseGLObjects( boost::python::ptr(arg0) );
    }
...
void register_Camera_class(){
    ...
    { //::osg::Camera
        typedef bp::class_< Camera_wrapper, bp::bases< osg::Transform, osg::CullSettings >, boost::noncopyable > Camera_exposer_t;
        ...
        bp::class_< Camera_wrapper::DrawCallback_wrapper, bp::bases< osg::Object >, boost::noncopyable >( "DrawCallback", bp::init< >() )    
            .def( bp::init< osg::Camera::DrawCallback const &, osg::CopyOp const & >(( bp::arg("arg0"), bp::arg("arg1") )) )    
            .def( 
                "className"
            ...
            .def( 
                "__call__"
                , (void ( ::osg::Camera::DrawCallback::* )( ::osg::Camera const & )const)(&::osg::Camera::DrawCallback::operator())
                , (void ( Camera_wrapper::DrawCallback_wrapper::* )( ::osg::Camera const & )const)(&Camera_wrapper::DrawCallback_wrapper::default___call__)
                , ( bp::arg("arg0") ) )    
            .def( 
                "computeDataVariance"
        ...
        Camera_exposer.def( bp::init< osg::Camera const &, bp::optional< osg::CopyOp const & > >(( bp::arg("arg0"), bp::arg("copyop")=SHALLOW_COPY )) );
        bp::implicitly_convertible< osg::Camera const &, osg::Camera >();
        { //::osg::Camera::accept
        ...
        { //::osg::Camera::releaseGLObjects
        
            typedef void ( ::osg::Camera::*releaseGLObjects_function_type)( ::osg::State * ) const;
            typedef void ( Camera_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            Camera_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::Camera::releaseGLObjects)
                , default_releaseGLObjects_function_type(&Camera_wrapper::default_releaseGLObjects)
        ...
        { //::osg::Node::asTerrain
            ...
            typedef ::osgTerrain::Terrain * ( Camera_wrapper::*default_asTerrain_function_type)(  ) ;
            
            Camera_exposer.def( 
                "asTerrain"
                , asTerrain_function_type(&::osg::Node::asTerrain)
                , default_asTerrain_function_type(&Camera_wrapper::default_asTerrain)
                    /* undefined call policies */ );
        ...
        { //::osg::Node::asTerrain
            ...
            typedef ::osgTerrain::Terrain const * ( Camera_wrapper::*default_asTerrain_function_type)(  ) const;
