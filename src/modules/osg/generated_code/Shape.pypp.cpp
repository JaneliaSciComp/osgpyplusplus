...
struct Shape_wrapper : osg::Shape, bp::wrapper< osg::Shape > {
    ...
    Shape_wrapper( )
    : osg::Shape( )
      , bp::wrapper< osg::Shape >(){
        // null constructor
    
    }

    Shape_wrapper(::osg::Shape const & sa, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::Shape( boost::ref(sa), boost::ref(copyop) )
      , bp::wrapper< osg::Shape >(){
        // constructor
...
void register_Shape_class(){
    ...
    bp::class_< Shape_wrapper, bp::bases< osg::Object >, boost::noncopyable >( "Shape", bp::no_init )    
        .def( bp::init< >() )    
        .def( bp::init< osg::Shape const &, bp::optional< osg::CopyOp const & > >(( bp::arg("sa"), bp::arg("copyop")=SHALLOW_COPY )) )    
        .def( 
            "accept"
