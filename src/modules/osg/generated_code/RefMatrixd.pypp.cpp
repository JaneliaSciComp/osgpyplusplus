...
struct RefMatrixd_wrapper : osg::RefMatrixd, bp::wrapper< osg::RefMatrixd > {
    ...
    RefMatrixd_wrapper(::osg::RefMatrixd const & other )
    : osg::RefMatrixd( boost::ref(other) )
      , bp::wrapper< osg::RefMatrixd >(){
        // copy constructor
...
void register_RefMatrixd_class(){
    ...
    { //::osg::RefMatrixd
        typedef bp::class_< RefMatrixd_wrapper, bp::bases< osg::Object, osg::Matrixd > > RefMatrixd_exposer_t;
        ...
        RefMatrixd_exposer.def( bp::init< osg::RefMatrixd const & >(( bp::arg("other") )) );
