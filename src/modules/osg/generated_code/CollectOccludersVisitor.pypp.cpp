...
void register_CollectOccludersVisitor_class(){
    ...
    bp::class_< CollectOccludersVisitor_wrapper, bp::bases< osg::NodeVisitor, osg::CullStack >, osg::ref_ptr< ::osg::CollectOccludersVisitor >, boost::noncopyable >( "CollectOccludersVisitor", bp::init< >() )    
        .def( 
            "apply"
