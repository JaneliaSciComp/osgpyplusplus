...
struct PrimitiveSet_wrapper : osg::PrimitiveSet, bp::wrapper< osg::PrimitiveSet > {
    ...
    PrimitiveSet_wrapper(::osg::PrimitiveSet::Type primType=::osg::PrimitiveSet::PrimitiveType, ::GLenum mode=0, int numInstances=0 )
    : osg::PrimitiveSet( primType, mode, numInstances )
      , bp::wrapper< osg::PrimitiveSet >(){
        // constructor
    
    }

    PrimitiveSet_wrapper(::osg::PrimitiveSet const & prim, ::osg::CopyOp const & copyop=SHALLOW_COPY )
    : osg::PrimitiveSet( boost::ref(prim), boost::ref(copyop) )
      , bp::wrapper< osg::PrimitiveSet >(){
        // constructor
...
void register_PrimitiveSet_class(){
    ...
    { //::osg::PrimitiveSet
        typedef bp::class_< PrimitiveSet_wrapper, bp::bases< osg::BufferData >, boost::noncopyable > PrimitiveSet_exposer_t;
        ...
        bp::enum_< osg::PrimitiveSet::Type>("Type")
            ...
            .export_values()
            ;
        PrimitiveSet_exposer.def( bp::init< bp::optional< osg::PrimitiveSet::Type, GLenum, int > >(( bp::arg("primType")=(long)(::osg::PrimitiveSet::PrimitiveType), bp::arg("mode")=(::GLenum)(0), bp::arg("numInstances")=(int)(0) )) );
        PrimitiveSet_exposer.def( bp::init< osg::PrimitiveSet const &, bp::optional< osg::CopyOp const & > >(( bp::arg("prim"), bp::arg("copyop")=SHALLOW_COPY )) );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image * ( PrimitiveSet_wrapper::*default_asImage_function_type)(  ) ;
            
            PrimitiveSet_exposer.def( 
                "asImage"
                , asImage_function_type(&::osg::BufferData::asImage)
                , default_asImage_function_type(&PrimitiveSet_wrapper::default_asImage)
                    /* undefined call policies */ );
        ...
        { //::osg::BufferData::asImage
            ...
            typedef ::osg::Image const * ( PrimitiveSet_wrapper::*default_asImage_function_type)(  ) const;
        ...
        { //::osg::BufferData::releaseGLObjects
            ...
            typedef void ( PrimitiveSet_wrapper::*default_releaseGLObjects_function_type)( ::osg::State * ) const;
            
            PrimitiveSet_exposer.def( 
                "releaseGLObjects"
                , releaseGLObjects_function_type(&::osg::BufferData::releaseGLObjects)
                , default_releaseGLObjects_function_type(&PrimitiveSet_wrapper::default_releaseGLObjects)
