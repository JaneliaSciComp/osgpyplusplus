...
void register_Program_class(){
    ...
    { //::osg::Program
        typedef bp::class_< Program_wrapper, bp::bases< osg::StateAttribute >, osg::ref_ptr< Program_wrapper >, boost::noncopyable > Program_exposer_t;
        ...
        bp::class_< Program_wrapper::PerContextProgram_wrapper, bp::bases< osg::Referenced >, osg::ref_ptr< Program_wrapper::PerContextProgram_wrapper >, boost::noncopyable >( "PerContextProgram", "\n PerContextProgram (PCP) is an OSG-internal encapsulation of glPrograms per-GL context.\n", bp::no_init )    
