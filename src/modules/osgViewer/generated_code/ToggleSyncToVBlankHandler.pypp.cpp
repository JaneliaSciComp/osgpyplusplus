...
struct ToggleSyncToVBlankHandler_wrapper : osgViewer::ToggleSyncToVBlankHandler, bp::wrapper< osgViewer::ToggleSyncToVBlankHandler > {

    ToggleSyncToVBlankHandler_wrapper( )
    : osgViewer::ToggleSyncToVBlankHandler( )
      , bp::wrapper< osgViewer::ToggleSyncToVBlankHandler >(){
        // null constructor
    ...
    virtual void getUsage( ::osg::ApplicationUsage & usage ) const  {
        if( bp::override func_getUsage = this->get_override( "getUsage" ) )
            ...
            this->osgViewer::ToggleSyncToVBlankHandler::getUsage( boost::ref(usage) );
        }
    }
    
    void default_getUsage( ::osg::ApplicationUsage & usage ) const  {
        osgViewer::ToggleSyncToVBlankHandler::getUsage( boost::ref(usage) );
    }
...
void register_ToggleSyncToVBlankHandler_class(){
    ...
    bp::class_< ToggleSyncToVBlankHandler_wrapper, osg::ref_ptr< ::osgViewer::ToggleSyncToVBlankHandler >, boost::noncopyable >( "ToggleSyncToVBlankHandler", bp::init< >() )    
        .def( 
