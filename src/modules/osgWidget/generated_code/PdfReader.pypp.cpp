...
struct PdfReader_wrapper : osgWidget::PdfReader, bp::wrapper< osgWidget::PdfReader > {

    PdfReader_wrapper( )
    : osgWidget::PdfReader( )
      , bp::wrapper< osgWidget::PdfReader >(){
        // null constructor
    
    }

    PdfReader_wrapper(::std::string const & filename, ::osgWidget::GeometryHints const & hints=osgWidget::GeometryHints() )
    : osgWidget::PdfReader( filename, boost::ref(hints) )
      , bp::wrapper< osgWidget::PdfReader >(){
        // constructor
