...
void register_OutputException_class(){
    ...
    bp::class_< OutputException_wrapper, bp::bases< ::osg::Referenced >, boost::noncopyable >( "OutputException", bp::init< std::vector< std::string > const &, std::string const & >(( bp::arg("fields"), bp::arg("err") )) )    
        .def( 
            "getError"
