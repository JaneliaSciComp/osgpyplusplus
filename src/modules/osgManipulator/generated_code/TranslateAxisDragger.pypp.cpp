...
struct TranslateAxisDragger_wrapper : osgManipulator::TranslateAxisDragger, bp::wrapper< osgManipulator::TranslateAxisDragger > {
    ...
    static void default_dispatch( ::osgManipulator::Dragger & inst, ::osgManipulator::MotionCommand & command ){
        if( dynamic_cast< TranslateAxisDragger_wrapper * >( boost::addressof( inst ) ) ){
...
void register_TranslateAxisDragger_class(){
    ...
    bp::class_< TranslateAxisDragger_wrapper, bp::bases< osgManipulator::CompositeDragger >, osg::ref_ptr< ::osgManipulator::TranslateAxisDragger >, boost::noncopyable >( "TranslateAxisDragger", "\n Dragger for performing translation in all three axes.\n", bp::no_init )    
        ...
        .def( 
            "dispatch"
            , (void (*)( ::osgManipulator::Dragger &,::osgManipulator::MotionCommand & ))( &TranslateAxisDragger_wrapper::default_dispatch )
        ...
        .def( 
            ...
            , (boost::python::object (*)( ::osgManipulator::Dragger &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & ))( &TranslateAxisDragger_wrapper::default_handle_bfc7c2b1255fcef353f72f723625fd47 )
            , ( bp::arg("inst"), bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "handle"
            , (boost::python::object (*)( ::osgManipulator::CompositeDragger &,::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & ))( &TranslateAxisDragger_wrapper::default_handle )
            , ( bp::arg("inst"), bp::arg("pi"), bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "receive"
            , (boost::python::object (*)( ::osgManipulator::Dragger &,::osgManipulator::MotionCommand & ))( &TranslateAxisDragger_wrapper::default_receive )
            , ( bp::arg("inst"), bp::arg("command") )
