...
struct Scale2DDragger_wrapper : osgManipulator::Scale2DDragger, bp::wrapper< osgManipulator::Scale2DDragger > {
    ...
    static boost::python::object default_handle( ::osgManipulator::Scale2DDragger & inst, ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter & ea, ::osgGA::GUIActionAdapter & us ){
        bool result;
        if( dynamic_cast< Scale2DDragger_wrapper * >( boost::addressof( inst ) ) ){
            result = inst.::osgManipulator::Scale2DDragger::handle(pi, ea, us);
        }
        else{
...
void register_Scale2DDragger_class(){
    ...
    { //::osgManipulator::Scale2DDragger
        ...
        { //::osgManipulator::Scale2DDragger::handle
            ...
            typedef boost::python::object ( *default_handle_function_type )( ::osgManipulator::Scale2DDragger &,::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & );
        ...
        { //::osgManipulator::Dragger::handle
            ...
            Scale2DDragger_exposer.def( 
                ...
                , default_handle_bfc7c2b1255fcef353f72f723625fd47_function_type( &Scale2DDragger_wrapper::default_handle_bfc7c2b1255fcef353f72f723625fd47 )
