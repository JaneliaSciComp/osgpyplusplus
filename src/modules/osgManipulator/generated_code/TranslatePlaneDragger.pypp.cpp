...
struct TranslatePlaneDragger_wrapper : osgManipulator::TranslatePlaneDragger, bp::wrapper< osgManipulator::TranslatePlaneDragger > {
    ...
    static boost::python::object default_handle( ::osgManipulator::TranslatePlaneDragger & inst, ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter & ea, ::osgGA::GUIActionAdapter & us ){
        bool result;
        if( dynamic_cast< TranslatePlaneDragger_wrapper * >( boost::addressof( inst ) ) ){
            result = inst.::osgManipulator::TranslatePlaneDragger::handle(pi, ea, us);
        }
        else{
...
void register_TranslatePlaneDragger_class(){
    ...
    bp::class_< TranslatePlaneDragger_wrapper, bp::bases< osgManipulator::CompositeDragger >, osg::ref_ptr< TranslatePlaneDragger_wrapper >, boost::noncopyable >( "TranslatePlaneDragger", "\n Translate plane dragger consists of a wireframe box representing a plane that can be dragged to translate along the plane.\n", bp::no_init )    
        ...
        .def( 
            "handle"
            , (boost::python::object (*)( ::osgManipulator::TranslatePlaneDragger &,::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & ))( &TranslatePlaneDragger_wrapper::default_handle )
        ...
        .def( 
            "dispatch"
            , (void (*)( ::osgManipulator::Dragger &,::osgManipulator::MotionCommand & ))( &TranslatePlaneDragger_wrapper::default_dispatch )
        ...
        .def( 
            "receive"
            , (boost::python::object (*)( ::osgManipulator::Dragger &,::osgManipulator::MotionCommand & ))( &TranslatePlaneDragger_wrapper::default_receive )
            , ( bp::arg("inst"), bp::arg("command") )
