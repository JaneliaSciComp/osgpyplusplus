...
struct Scale1DCommand_wrapper : osgManipulator::Scale1DCommand, bp::wrapper< osgManipulator::Scale1DCommand > {
    ...
    virtual void accept( ::osgManipulator::Constraint const & constraint ) {
        if( bp::override func_accept = this->get_override( "accept" ) )
            ...
            this->osgManipulator::Scale1DCommand::accept( boost::ref(constraint) );
        }
    }
...
void register_Scale1DCommand_class(){
    ...
    bp::class_< Scale1DCommand_wrapper, bp::bases< osgManipulator::MotionCommand >, osg::ref_ptr< ::osgManipulator::Scale1DCommand >, boost::noncopyable >( "Scale1DCommand", "\n Command for 1D scaling.\n", bp::no_init )    
        ...
        .def( 
            "accept"
            , (void ( ::osgManipulator::Scale1DCommand::* )( ::osgManipulator::Constraint const & ))(&::osgManipulator::Scale1DCommand::accept)
            , (void ( Scale1DCommand_wrapper::* )( ::osgManipulator::Constraint const & ))(&Scale1DCommand_wrapper::default_accept)
            , ( bp::arg("constraint") ) )    
        .def( 
            "accept"
