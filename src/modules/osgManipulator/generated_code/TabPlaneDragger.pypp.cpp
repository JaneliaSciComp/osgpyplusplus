...
struct TabPlaneDragger_wrapper : osgManipulator::TabPlaneDragger, bp::wrapper< osgManipulator::TabPlaneDragger > {

    TabPlaneDragger_wrapper(float handleScaleFactor=2.0e+1f )
    : osgManipulator::TabPlaneDragger( handleScaleFactor )
      , bp::wrapper< osgManipulator::TabPlaneDragger >(){
        // constructor
    ...
    virtual char const * className(  ) const  {
        if( bp::override func_className = this->get_override( "className" ) )
            ...
            return this->osgManipulator::TabPlaneDragger::className(  );
        }
    }
    
    char const * default_className(  ) const  {
        return osgManipulator::TabPlaneDragger::className( );
    }
    ...
    virtual ::osg::Object * cloneType(  ) const  {
        if( bp::override func_cloneType = this->get_override( "cloneType" ) )
            ...
            return this->osgManipulator::TabPlaneDragger::cloneType(  );
        }
    }
    
    ::osg::Object * default_cloneType(  ) const  {
        return osgManipulator::TabPlaneDragger::cloneType( );
    }
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            ...
            return this->osgManipulator::TabPlaneDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(us) );
        }
    }
    
    bool default_handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        return osgManipulator::TabPlaneDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(us) );
    }
    ...
    virtual bool isSameKindAs( ::osg::Object const * obj ) const  {
        if( bp::override func_isSameKindAs = this->get_override( "isSameKindAs" ) )
            ...
            return this->osgManipulator::TabPlaneDragger::isSameKindAs( boost::python::ptr(obj) );
        }
    }
    
    bool default_isSameKindAs( ::osg::Object const * obj ) const  {
        return osgManipulator::TabPlaneDragger::isSameKindAs( boost::python::ptr(obj) );
    }
    ...
    virtual char const * libraryName(  ) const  {
        if( bp::override func_libraryName = this->get_override( "libraryName" ) )
            ...
            return this->osgManipulator::TabPlaneDragger::libraryName(  );
        }
    }
    
    char const * default_libraryName(  ) const  {
        return osgManipulator::TabPlaneDragger::libraryName( );
    }
    ...
    { //::osgManipulator::TabPlaneDragger
        ...
        { //::osgManipulator::TabPlaneDragger::className
            ...
            TabPlaneDragger_exposer.def( 
                "className"
                , className_function_type(&::osgManipulator::TabPlaneDragger::className)
                , default_className_function_type(&TabPlaneDragger_wrapper::default_className) );
        ...
        { //::osgManipulator::TabPlaneDragger::cloneType
            ...
            TabPlaneDragger_exposer.def( 
                "cloneType"
                , cloneType_function_type(&::osgManipulator::TabPlaneDragger::cloneType)
                , default_cloneType_function_type(&TabPlaneDragger_wrapper::default_cloneType)
                , bp::return_value_policy< bp::reference_existing_object >() );
        
        }
        { //::osgManipulator::TabPlaneDragger::handle
        
            typedef bool ( ::osgManipulator::TabPlaneDragger::*handle_function_type)( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ) ;
            typedef bool ( TabPlaneDragger_wrapper::*default_handle_function_type)( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ) ;
            
            TabPlaneDragger_exposer.def( 
                "handle"
                , handle_function_type(&::osgManipulator::TabPlaneDragger::handle)
                , default_handle_function_type(&TabPlaneDragger_wrapper::default_handle)
        ...
        { //::osgManipulator::TabPlaneDragger::isSameKindAs
            ...
            TabPlaneDragger_exposer.def( 
                "isSameKindAs"
                , isSameKindAs_function_type(&::osgManipulator::TabPlaneDragger::isSameKindAs)
                , default_isSameKindAs_function_type(&TabPlaneDragger_wrapper::default_isSameKindAs)
                , ( bp::arg("obj") ) );
        ...
        { //::osgManipulator::TabPlaneDragger::libraryName
            ...
            TabPlaneDragger_exposer.def( 
                "libraryName"
                , libraryName_function_type(&::osgManipulator::TabPlaneDragger::libraryName)
                , default_libraryName_function_type(&TabPlaneDragger_wrapper::default_libraryName) );
        ...
        { //::osgManipulator::TabPlaneDragger::setPlaneColor
            ...
            TabPlaneDragger_exposer.def( 
                "setPlaneColor"
                , setPlaneColor_function_type( &::osgManipulator::TabPlaneDragger::setPlaneColor )
                , ( bp::arg("color") ) );
        ...
        { //::osgManipulator::TabPlaneDragger::setupDefaultGeometry
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , setupDefaultGeometry_function_type( &::osgManipulator::TabPlaneDragger::setupDefaultGeometry )
                , ( bp::arg("twoSidedHandle")=(bool)(true) )
        ...
        { //::osgManipulator::CompositeDragger::accept
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_accept_function_type(&TabPlaneDragger_wrapper::default_accept)
                , ( bp::arg("nv") ) );
        ...
        { //::osgManipulator::CompositeDragger::addDragger
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_addDragger_function_type(&TabPlaneDragger_wrapper::default_addDragger)
                , ( bp::arg("dragger") ) );
        ...
        { //::osgManipulator::CompositeDragger::clone
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_clone_function_type(&TabPlaneDragger_wrapper::default_clone)
                , ( bp::arg("copyop") )
                , bp::return_value_policy< bp::reference_existing_object >() );
        ...
        { //::osgManipulator::Dragger::dispatch
            ...
            typedef void ( TabPlaneDragger_wrapper::*default_dispatch_function_type)( ::osgManipulator::MotionCommand & ) ;
            
            TabPlaneDragger_exposer.def( 
                "dispatch"
                , dispatch_function_type(&::osgManipulator::Dragger::dispatch)
                , default_dispatch_function_type(&TabPlaneDragger_wrapper::default_dispatch)
                , ( bp::arg("command") ) );
        ...
        { //::osgManipulator::CompositeDragger::getComposite
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_getComposite_function_type(&TabPlaneDragger_wrapper::default_getComposite)
        ...
        { //::osgManipulator::Dragger::handle
            ...
            typedef bool ( TabPlaneDragger_wrapper::*default_handle_function_type)( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ) ;
        ...
        { //::osgManipulator::Dragger::receive
            ...
            typedef bool ( TabPlaneDragger_wrapper::*default_receive_function_type)( ::osgManipulator::MotionCommand const & ) ;
            
            TabPlaneDragger_exposer.def( 
                "receive"
                , receive_function_type(&::osgManipulator::Dragger::receive)
                , default_receive_function_type(&TabPlaneDragger_wrapper::default_receive)
                , ( bp::arg("command") ) );
        ...
        { //::osgManipulator::CompositeDragger::removeDragger
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_removeDragger_function_type(&TabPlaneDragger_wrapper::default_removeDragger)
                , ( bp::arg("dragger") ) );
        ...
        { //::osgManipulator::CompositeDragger::setIntersectionMask
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_setIntersectionMask_function_type(&TabPlaneDragger_wrapper::default_setIntersectionMask)
        ...
        { //::osgManipulator::CompositeDragger::setParentDragger
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_setParentDragger_function_type(&TabPlaneDragger_wrapper::default_setParentDragger)
                , ( bp::arg("parent") ) );
        ...
        { //::osgManipulator::Dragger::setupDefaultGeometry
            ...
            TabPlaneDragger_exposer.def( 
                "setupDefaultGeometry"
                , setupDefaultGeometry_function_type(&::osgManipulator::Dragger::setupDefaultGeometry)
                , default_setupDefaultGeometry_function_type(&TabPlaneDragger_wrapper::default_setupDefaultGeometry) );
        ...
        { //::osgManipulator::Dragger::traverse
            ...
            TabPlaneDragger_exposer.def( 
                ...
                , default_traverse_function_type(&TabPlaneDragger_wrapper::default_traverse)
                , ( bp::arg("nv") ) );
