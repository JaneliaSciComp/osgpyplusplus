...
struct TabPlaneDragger_wrapper : osgManipulator::TabPlaneDragger, bp::wrapper< osgManipulator::TabPlaneDragger > {
    ...
    static boost::python::object default_handle( ::osgManipulator::TabPlaneDragger & inst, ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter & ea, ::osgGA::GUIActionAdapter & us ){
        bool result;
        if( dynamic_cast< TabPlaneDragger_wrapper * >( boost::addressof( inst ) ) ){
            result = inst.::osgManipulator::TabPlaneDragger::handle(pi, ea, us);
        }
        else{
...
void register_TabPlaneDragger_class(){
    ...
    { //::osgManipulator::TabPlaneDragger
        ...
        { //::osgManipulator::TabPlaneDragger::handle
            ...
            typedef boost::python::object ( *default_handle_function_type )( ::osgManipulator::TabPlaneDragger &,::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & );
