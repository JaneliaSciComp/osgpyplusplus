...
struct Dragger_wrapper : osgManipulator::Dragger, bp::wrapper< osgManipulator::Dragger > {
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & arg0, ::osgGA::GUIEventAdapter const & arg1, ::osgGA::GUIActionAdapter & arg2 ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            return func_handle( boost::ref(arg0), boost::ref(arg1), boost::ref(arg2) );
        else{
            return this->osgManipulator::Dragger::handle( boost::ref(arg0), boost::ref(arg1), boost::ref(arg2) );
        }
    }
    
    bool default_handle( ::osgManipulator::PointerInfo const & arg0, ::osgGA::GUIEventAdapter const & arg1, ::osgGA::GUIActionAdapter & arg2 ) {
...
void register_Dragger_class(){
    ...
    bp::class_< Dragger_wrapper, bp::bases< ::osg::MatrixTransform >, osg::ref_ptr< ::osgManipulator::Dragger >, boost::noncopyable >( "Dragger", "\n Base class for draggers. Concrete draggers implement the pick event handler\n and generate motion commands (translate, rotate, ...) and sends these\n command to all the DraggerCallbacks & Transforms that are connected to the Dragger that generates the\n commands.\n", bp::no_init )    
        ...
        .def( 
            ...
            , (void ( Dragger_wrapper::* )( ::osgManipulator::MotionCommand & ))(&Dragger_wrapper::default_dispatch)
            , ( bp::arg("command") ) )    
        .def( 
        ...
        .def( 
            ...
            , (bool ( Dragger_wrapper::* )( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&Dragger_wrapper::default_handle)
            , ( bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "handle"
            , (bool ( ::osgManipulator::Dragger::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&::osgManipulator::Dragger::handle)
            , (bool ( Dragger_wrapper::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&Dragger_wrapper::default_handle)
        ...
        .def( 
            ...
            , (bool ( Dragger_wrapper::* )( ::osgManipulator::MotionCommand const & ))(&Dragger_wrapper::default_receive)
            , ( bp::arg("command") ) )    
        .def( 
            "removeConstraint"
