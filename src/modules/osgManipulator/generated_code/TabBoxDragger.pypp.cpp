...
struct TabBoxDragger_wrapper : osgManipulator::TabBoxDragger, bp::wrapper< osgManipulator::TabBoxDragger > {
    ...
    static void default_dispatch( ::osgManipulator::Dragger & inst, ::osgManipulator::MotionCommand & command ){
        if( dynamic_cast< TabBoxDragger_wrapper * >( boost::addressof( inst ) ) ){
...
void register_TabBoxDragger_class(){
    ...
    bp::class_< TabBoxDragger_wrapper, bp::bases< osgManipulator::CompositeDragger >, osg::ref_ptr< ::osgManipulator::TabBoxDragger >, boost::noncopyable >( "TabBoxDragger", "\n TabBoxDragger consists of 6 TabPlaneDraggers to form a box dragger that\n performs translation and scaling.\n", bp::no_init )    
        ...
        .def( 
            "dispatch"
            , (void (*)( ::osgManipulator::Dragger &,::osgManipulator::MotionCommand & ))( &TabBoxDragger_wrapper::default_dispatch )
        ...
        .def( 
            "handle"
            , (boost::python::object (*)( ::osgManipulator::CompositeDragger &,::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & ))( &TabBoxDragger_wrapper::default_handle )
            , ( bp::arg("inst"), bp::arg("pi"), bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "receive"
            , (boost::python::object (*)( ::osgManipulator::Dragger &,::osgManipulator::MotionCommand & ))( &TabBoxDragger_wrapper::default_receive )
            , ( bp::arg("inst"), bp::arg("command") )
