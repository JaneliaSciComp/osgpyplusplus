...
struct ScaleAxisDragger_wrapper : osgManipulator::ScaleAxisDragger, bp::wrapper< osgManipulator::ScaleAxisDragger > {

    ScaleAxisDragger_wrapper( )
    : osgManipulator::ScaleAxisDragger( )
      , bp::wrapper< osgManipulator::ScaleAxisDragger >(){
        // null constructor
    ...
    virtual char const * className(  ) const  {
        if( bp::override func_className = this->get_override( "className" ) )
            ...
            return this->osgManipulator::ScaleAxisDragger::className(  );
        }
    }
    
    char const * default_className(  ) const  {
        return osgManipulator::ScaleAxisDragger::className( );
    }
    ...
    virtual ::osg::Object * cloneType(  ) const  {
        if( bp::override func_cloneType = this->get_override( "cloneType" ) )
            ...
            return this->osgManipulator::ScaleAxisDragger::cloneType(  );
        }
    }
    
    ::osg::Object * default_cloneType(  ) const  {
        return osgManipulator::ScaleAxisDragger::cloneType( );
    }
    ...
    virtual bool isSameKindAs( ::osg::Object const * obj ) const  {
        if( bp::override func_isSameKindAs = this->get_override( "isSameKindAs" ) )
            ...
            return this->osgManipulator::ScaleAxisDragger::isSameKindAs( boost::python::ptr(obj) );
        }
    }
    
    bool default_isSameKindAs( ::osg::Object const * obj ) const  {
        return osgManipulator::ScaleAxisDragger::isSameKindAs( boost::python::ptr(obj) );
    }
    ...
    virtual char const * libraryName(  ) const  {
        if( bp::override func_libraryName = this->get_override( "libraryName" ) )
            ...
            return this->osgManipulator::ScaleAxisDragger::libraryName(  );
        }
    }
    
    char const * default_libraryName(  ) const  {
        return osgManipulator::ScaleAxisDragger::libraryName( );
    }
    ...
    virtual void setupDefaultGeometry(  ) {
        if( bp::override func_setupDefaultGeometry = this->get_override( "setupDefaultGeometry" ) )
            ...
            this->osgManipulator::ScaleAxisDragger::setupDefaultGeometry(  );
        }
    }
    
    void default_setupDefaultGeometry(  ) {
        osgManipulator::ScaleAxisDragger::setupDefaultGeometry( );
    }
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & aa ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            return func_handle( boost::ref(pi), boost::ref(ea), boost::ref(aa) );
        else{
            return this->osgManipulator::CompositeDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(aa) );
        }
    }
    
    bool default_handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & aa ) {
...
void register_ScaleAxisDragger_class(){
    ...
    bp::class_< ScaleAxisDragger_wrapper, bp::bases< osgManipulator::CompositeDragger >, osg::ref_ptr< ::osgManipulator::ScaleAxisDragger >, boost::noncopyable >( "ScaleAxisDragger", "\n Dragger for performing scaling on all 3 axes.\n", bp::no_init )    
        ...
        .def( 
            "className"
            , (char const * ( ::osgManipulator::ScaleAxisDragger::* )(  )const)(&::osgManipulator::ScaleAxisDragger::className)
            , (char const * ( ScaleAxisDragger_wrapper::* )(  )const)(&ScaleAxisDragger_wrapper::default_className) )    
        .def( 
            "cloneType"
            , (::osg::Object * ( ::osgManipulator::ScaleAxisDragger::* )(  )const)(&::osgManipulator::ScaleAxisDragger::cloneType)
            , (::osg::Object * ( ScaleAxisDragger_wrapper::* )(  )const)(&ScaleAxisDragger_wrapper::default_cloneType)
            , bp::return_value_policy< bp::reference_existing_object >() )    
        .def( 
            "isSameKindAs"
            , (bool ( ::osgManipulator::ScaleAxisDragger::* )( ::osg::Object const * )const)(&::osgManipulator::ScaleAxisDragger::isSameKindAs)
            , (bool ( ScaleAxisDragger_wrapper::* )( ::osg::Object const * )const)(&ScaleAxisDragger_wrapper::default_isSameKindAs)
            , ( bp::arg("obj") ) )    
        .def( 
            "libraryName"
            , (char const * ( ::osgManipulator::ScaleAxisDragger::* )(  )const)(&::osgManipulator::ScaleAxisDragger::libraryName)
            , (char const * ( ScaleAxisDragger_wrapper::* )(  )const)(&ScaleAxisDragger_wrapper::default_libraryName) )    
        .def( 
            "setupDefaultGeometry"
            , (void ( ::osgManipulator::ScaleAxisDragger::* )(  ))(&::osgManipulator::ScaleAxisDragger::setupDefaultGeometry)
            , (void ( ScaleAxisDragger_wrapper::* )(  ))(&ScaleAxisDragger_wrapper::default_setupDefaultGeometry) )    
        .def( 
            "accept"
            , (void ( ::osgManipulator::CompositeDragger::* )( ::osg::NodeVisitor & ))(&::osgManipulator::CompositeDragger::accept)
            , (void ( ScaleAxisDragger_wrapper::* )( ::osg::NodeVisitor & ))(&ScaleAxisDragger_wrapper::default_accept)
            , ( bp::arg("nv") ) )    
        .def( 
            "addDragger"
            , (bool ( ::osgManipulator::CompositeDragger::* )( ::osgManipulator::Dragger * ))(&::osgManipulator::CompositeDragger::addDragger)
            , (bool ( ScaleAxisDragger_wrapper::* )( ::osgManipulator::Dragger * ))(&ScaleAxisDragger_wrapper::default_addDragger)
            , ( bp::arg("dragger") ) )    
        .def( 
            "clone"
            , (::osg::Object * ( ::osgManipulator::CompositeDragger::* )( ::osg::CopyOp const & )const)(&::osgManipulator::CompositeDragger::clone)
            , (::osg::Object * ( ScaleAxisDragger_wrapper::* )( ::osg::CopyOp const & )const)(&ScaleAxisDragger_wrapper::default_clone)
            , ( bp::arg("copyop") )
            , bp::return_value_policy< bp::reference_existing_object >() )    
        .def( 
            "dispatch"
            , (void ( ::osgManipulator::Dragger::* )( ::osgManipulator::MotionCommand & ))(&::osgManipulator::Dragger::dispatch)
            , (void ( ScaleAxisDragger_wrapper::* )( ::osgManipulator::MotionCommand & ))(&ScaleAxisDragger_wrapper::default_dispatch)
            , ( bp::arg("command") ) )    
        .def( 
            "getComposite"
            , (::osgManipulator::CompositeDragger const * ( ::osgManipulator::CompositeDragger::* )(  )const)(&::osgManipulator::CompositeDragger::getComposite)
            , (::osgManipulator::CompositeDragger const * ( ScaleAxisDragger_wrapper::* )(  )const)(&ScaleAxisDragger_wrapper::default_getComposite)
            , bp::return_internal_reference< >() )    
        .def( 
            "getComposite"
            , (::osgManipulator::CompositeDragger * ( ::osgManipulator::CompositeDragger::* )(  ))(&::osgManipulator::CompositeDragger::getComposite)
            , (::osgManipulator::CompositeDragger * ( ScaleAxisDragger_wrapper::* )(  ))(&ScaleAxisDragger_wrapper::default_getComposite)
            , bp::return_internal_reference< >() )    
        .def( 
            "handle"
            , (bool ( ::osgManipulator::Dragger::* )( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&::osgManipulator::Dragger::handle)
            , (bool ( ScaleAxisDragger_wrapper::* )( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&ScaleAxisDragger_wrapper::default_handle)
            , ( bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "handle"
            , (bool ( ::osgManipulator::CompositeDragger::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&::osgManipulator::CompositeDragger::handle)
            , (bool ( ScaleAxisDragger_wrapper::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&ScaleAxisDragger_wrapper::default_handle)
            , ( bp::arg("pi"), bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "receive"
            , (bool ( ::osgManipulator::Dragger::* )( ::osgManipulator::MotionCommand const & ))(&::osgManipulator::Dragger::receive)
            , (bool ( ScaleAxisDragger_wrapper::* )( ::osgManipulator::MotionCommand const & ))(&ScaleAxisDragger_wrapper::default_receive)
            , ( bp::arg("command") ) )    
        .def( 
            "removeDragger"
            , (bool ( ::osgManipulator::CompositeDragger::* )( ::osgManipulator::Dragger * ))(&::osgManipulator::CompositeDragger::removeDragger)
            , (bool ( ScaleAxisDragger_wrapper::* )( ::osgManipulator::Dragger * ))(&ScaleAxisDragger_wrapper::default_removeDragger)
            , ( bp::arg("dragger") ) )    
        .def( 
            "setIntersectionMask"
            , (void ( ::osgManipulator::CompositeDragger::* )( unsigned int ))(&::osgManipulator::CompositeDragger::setIntersectionMask)
            , (void ( ScaleAxisDragger_wrapper::* )( unsigned int ))(&ScaleAxisDragger_wrapper::default_setIntersectionMask)
        ...
        .def( 
            ...
            , (void ( ScaleAxisDragger_wrapper::* )( ::osgManipulator::Dragger * ))(&ScaleAxisDragger_wrapper::default_setParentDragger)
            , ( bp::arg("parent") ) )    
        .def( 
            "traverse"
            , (void ( ::osgManipulator::Dragger::* )( ::osg::NodeVisitor & ))(&::osgManipulator::Dragger::traverse)
            , (void ( ScaleAxisDragger_wrapper::* )( ::osg::NodeVisitor & ))(&ScaleAxisDragger_wrapper::default_traverse)
            , ( bp::arg("nv") ) );
