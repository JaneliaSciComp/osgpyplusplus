...
struct RotateSphereDragger_wrapper : osgManipulator::RotateSphereDragger, bp::wrapper< osgManipulator::RotateSphereDragger > {
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & arg0, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            return func_handle( boost::ref(arg0), boost::ref(ea), boost::ref(us) );
        else{
            return this->osgManipulator::RotateSphereDragger::handle( boost::ref(arg0), boost::ref(ea), boost::ref(us) );
        }
    }
    
    bool default_handle( ::osgManipulator::PointerInfo const & arg0, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
...
void register_RotateSphereDragger_class(){
    ...
    bp::class_< RotateSphereDragger_wrapper, bp::bases< osgManipulator::Dragger >, osg::ref_ptr< ::osgManipulator::RotateSphereDragger >, boost::noncopyable >( "RotateSphereDragger", "\n Dragger for performing 3D rotation on a sphere.\n", bp::no_init )    
        ...
        .def( 
            "handle"
            , (bool ( ::osgManipulator::RotateSphereDragger::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&::osgManipulator::RotateSphereDragger::handle)
            , (bool ( RotateSphereDragger_wrapper::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&RotateSphereDragger_wrapper::default_handle)
            , ( bp::arg("arg0"), bp::arg("ea"), bp::arg("us") ) )    
        .def( 
            "isSameKindAs"
        ...
        .def( 
            ...
            , (void ( RotateSphereDragger_wrapper::* )( ::osgManipulator::MotionCommand & ))(&RotateSphereDragger_wrapper::default_dispatch)
            , ( bp::arg("command") ) )    
        .def( 
            "getComposite"
        ...
        .def( 
            ...
            , (bool ( RotateSphereDragger_wrapper::* )( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&RotateSphereDragger_wrapper::default_handle)
            , ( bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "receive"
            , (bool ( ::osgManipulator::Dragger::* )( ::osgManipulator::MotionCommand const & ))(&::osgManipulator::Dragger::receive)
            , (bool ( RotateSphereDragger_wrapper::* )( ::osgManipulator::MotionCommand const & ))(&RotateSphereDragger_wrapper::default_receive)
            , ( bp::arg("command") ) )    
        .def( 
            "setIntersectionMask"
