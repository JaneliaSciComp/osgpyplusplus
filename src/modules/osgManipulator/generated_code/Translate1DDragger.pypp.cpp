...
struct Translate1DDragger_wrapper : osgManipulator::Translate1DDragger, bp::wrapper< osgManipulator::Translate1DDragger > {
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            ...
            return this->osgManipulator::Translate1DDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(us) );
        }
    }
...
void register_Translate1DDragger_class(){
    ...
    bp::class_< Translate1DDragger_wrapper, bp::bases< osgManipulator::Dragger >, osg::ref_ptr< ::osgManipulator::Translate1DDragger >, boost::noncopyable >( "Translate1DDragger", "\n Dragger for performing 1D translation.\n", bp::no_init )    
        ...
        .def( 
            "handle"
            , (bool ( ::osgManipulator::Translate1DDragger::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&::osgManipulator::Translate1DDragger::handle)
            , (bool ( Translate1DDragger_wrapper::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&Translate1DDragger_wrapper::default_handle)
        ...
        .def( 
            ...
            , (void ( Translate1DDragger_wrapper::* )( ::osgManipulator::MotionCommand & ))(&Translate1DDragger_wrapper::default_dispatch)
            , ( bp::arg("command") ) )    
        .def( 
            "getComposite"
        ...
        .def( 
            ...
            , (bool ( Translate1DDragger_wrapper::* )( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&Translate1DDragger_wrapper::default_handle)
            , ( bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "receive"
            , (bool ( ::osgManipulator::Dragger::* )( ::osgManipulator::MotionCommand const & ))(&::osgManipulator::Dragger::receive)
            , (bool ( Translate1DDragger_wrapper::* )( ::osgManipulator::MotionCommand const & ))(&Translate1DDragger_wrapper::default_receive)
            , ( bp::arg("command") ) )    
        .def( 
            "setIntersectionMask"
