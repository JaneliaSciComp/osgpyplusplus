...
struct Translate2DDragger_wrapper : osgManipulator::Translate2DDragger, bp::wrapper< osgManipulator::Translate2DDragger > {

    Translate2DDragger_wrapper( )
    : osgManipulator::Translate2DDragger( )
      , bp::wrapper< osgManipulator::Translate2DDragger >(){
        // null constructor
    
    }

    Translate2DDragger_wrapper(::osg::Plane const & plane )
    : osgManipulator::Translate2DDragger( boost::ref(plane) )
      , bp::wrapper< osgManipulator::Translate2DDragger >(){
        // constructor
    ...
    virtual char const * className(  ) const  {
        if( bp::override func_className = this->get_override( "className" ) )
            ...
            return this->osgManipulator::Translate2DDragger::className(  );
        }
    }
    
    char const * default_className(  ) const  {
        return osgManipulator::Translate2DDragger::className( );
    }
    ...
    virtual ::osg::Object * cloneType(  ) const  {
        if( bp::override func_cloneType = this->get_override( "cloneType" ) )
            ...
            return this->osgManipulator::Translate2DDragger::cloneType(  );
        }
    }
    
    ::osg::Object * default_cloneType(  ) const  {
        return osgManipulator::Translate2DDragger::cloneType( );
    }
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            ...
            return this->osgManipulator::Translate2DDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(us) );
        }
    }
    
    bool default_handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        return osgManipulator::Translate2DDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(us) );
    }
    ...
    virtual bool isSameKindAs( ::osg::Object const * obj ) const  {
        if( bp::override func_isSameKindAs = this->get_override( "isSameKindAs" ) )
            ...
            return this->osgManipulator::Translate2DDragger::isSameKindAs( boost::python::ptr(obj) );
        }
    }
    
    bool default_isSameKindAs( ::osg::Object const * obj ) const  {
        return osgManipulator::Translate2DDragger::isSameKindAs( boost::python::ptr(obj) );
    }
    ...
    virtual char const * libraryName(  ) const  {
        if( bp::override func_libraryName = this->get_override( "libraryName" ) )
            ...
            return this->osgManipulator::Translate2DDragger::libraryName(  );
        }
    }
    
    char const * default_libraryName(  ) const  {
        return osgManipulator::Translate2DDragger::libraryName( );
    }
    ...
    virtual void setupDefaultGeometry(  ) {
        if( bp::override func_setupDefaultGeometry = this->get_override( "setupDefaultGeometry" ) )
            ...
            this->osgManipulator::Translate2DDragger::setupDefaultGeometry(  );
        }
    }
...
void register_Translate2DDragger_class(){
    ...
    { //::osgManipulator::Translate2DDragger
        ...
        Translate2DDragger_exposer.def( bp::init< osg::Plane const & >(( bp::arg("plane") )) );
        ...
        { //::osgManipulator::Translate2DDragger::className
            ...
            Translate2DDragger_exposer.def( 
                "className"
                , className_function_type(&::osgManipulator::Translate2DDragger::className)
                , default_className_function_type(&Translate2DDragger_wrapper::default_className) );
        ...
        { //::osgManipulator::Translate2DDragger::cloneType
            ...
            Translate2DDragger_exposer.def( 
                "cloneType"
                , cloneType_function_type(&::osgManipulator::Translate2DDragger::cloneType)
                , default_cloneType_function_type(&Translate2DDragger_wrapper::default_cloneType)
        ...
        { //::osgManipulator::Translate2DDragger::getColor
            ...
            Translate2DDragger_exposer.def( 
                "getColor"
                , getColor_function_type( &::osgManipulator::Translate2DDragger::getColor )
        ...
        { //::osgManipulator::Translate2DDragger::getPickColor
            ...
            Translate2DDragger_exposer.def( 
                "getPickColor"
                , getPickColor_function_type( &::osgManipulator::Translate2DDragger::getPickColor )
                , bp::return_internal_reference< >() );
        
        }
        { //::osgManipulator::Translate2DDragger::handle
        
            typedef bool ( ::osgManipulator::Translate2DDragger::*handle_function_type)( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ) ;
            typedef bool ( Translate2DDragger_wrapper::*default_handle_function_type)( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ) ;
            
            Translate2DDragger_exposer.def( 
                "handle"
                , handle_function_type(&::osgManipulator::Translate2DDragger::handle)
                , default_handle_function_type(&Translate2DDragger_wrapper::default_handle)
        ...
        { //::osgManipulator::Translate2DDragger::isSameKindAs
            ...
            Translate2DDragger_exposer.def( 
                "isSameKindAs"
                , isSameKindAs_function_type(&::osgManipulator::Translate2DDragger::isSameKindAs)
                , default_isSameKindAs_function_type(&Translate2DDragger_wrapper::default_isSameKindAs)
                , ( bp::arg("obj") ) );
        ...
        { //::osgManipulator::Translate2DDragger::libraryName
            ...
            Translate2DDragger_exposer.def( 
                "libraryName"
                , libraryName_function_type(&::osgManipulator::Translate2DDragger::libraryName)
                , default_libraryName_function_type(&Translate2DDragger_wrapper::default_libraryName) );
        ...
        { //::osgManipulator::Translate2DDragger::setColor
            ...
            Translate2DDragger_exposer.def( 
                "setColor"
                , setColor_function_type( &::osgManipulator::Translate2DDragger::setColor )
                , ( bp::arg("color") )
        ...
        { //::osgManipulator::Translate2DDragger::setPickColor
            ...
            Translate2DDragger_exposer.def( 
                "setPickColor"
                , setPickColor_function_type( &::osgManipulator::Translate2DDragger::setPickColor )
                , ( bp::arg("color") )
        ...
        { //::osgManipulator::Translate2DDragger::setupDefaultGeometry
            ...
            Translate2DDragger_exposer.def( 
                ...
                , setupDefaultGeometry_function_type(&::osgManipulator::Translate2DDragger::setupDefaultGeometry)
                , default_setupDefaultGeometry_function_type(&Translate2DDragger_wrapper::default_setupDefaultGeometry) );
        ...
        { //::osgManipulator::Dragger::accept
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_accept_function_type(&Translate2DDragger_wrapper::default_accept)
                , ( bp::arg("nv") ) );
        ...
        { //::osgManipulator::Dragger::clone
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_clone_function_type(&Translate2DDragger_wrapper::default_clone)
                , ( bp::arg("copyop") )
                , bp::return_value_policy< bp::reference_existing_object >() );
        ...
        { //::osgManipulator::Dragger::dispatch
            ...
            typedef void ( Translate2DDragger_wrapper::*default_dispatch_function_type)( ::osgManipulator::MotionCommand & ) ;
            
            Translate2DDragger_exposer.def( 
                "dispatch"
                , dispatch_function_type(&::osgManipulator::Dragger::dispatch)
                , default_dispatch_function_type(&Translate2DDragger_wrapper::default_dispatch)
                , ( bp::arg("command") ) );
        ...
        { //::osgManipulator::Dragger::getComposite
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_getComposite_function_type(&Translate2DDragger_wrapper::default_getComposite)
                , bp::return_internal_reference< >() );
        ...
        { //::osgManipulator::Dragger::handle
            ...
            typedef bool ( Translate2DDragger_wrapper::*default_handle_function_type)( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ) ;
        ...
        { //::osgManipulator::Dragger::receive
            ...
            typedef bool ( Translate2DDragger_wrapper::*default_receive_function_type)( ::osgManipulator::MotionCommand const & ) ;
            
            Translate2DDragger_exposer.def( 
                "receive"
                , receive_function_type(&::osgManipulator::Dragger::receive)
                , default_receive_function_type(&Translate2DDragger_wrapper::default_receive)
                , ( bp::arg("command") ) );
        ...
        { //::osgManipulator::Dragger::setIntersectionMask
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_setIntersectionMask_function_type(&Translate2DDragger_wrapper::default_setIntersectionMask)
        ...
        { //::osgManipulator::Dragger::setParentDragger
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_setParentDragger_function_type(&Translate2DDragger_wrapper::default_setParentDragger)
                , ( bp::arg("parent") ) );
        ...
        { //::osgManipulator::Dragger::traverse
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_traverse_function_type(&Translate2DDragger_wrapper::default_traverse)
                , ( bp::arg("nv") ) );
