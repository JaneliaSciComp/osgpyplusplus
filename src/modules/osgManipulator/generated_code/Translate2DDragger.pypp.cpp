...
struct Translate2DDragger_wrapper : osgManipulator::Translate2DDragger, bp::wrapper< osgManipulator::Translate2DDragger > {
    ...
    static boost::python::object default_handle( ::osgManipulator::Translate2DDragger & inst, ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter & ea, ::osgGA::GUIActionAdapter & us ){
        bool result;
        if( dynamic_cast< Translate2DDragger_wrapper * >( boost::addressof( inst ) ) ){
            result = inst.::osgManipulator::Translate2DDragger::handle(pi, ea, us);
        }
        else{
...
void register_Translate2DDragger_class(){
    ...
    { //::osgManipulator::Translate2DDragger
        ...
        { //::osgManipulator::Translate2DDragger::handle
            ...
            typedef boost::python::object ( *default_handle_function_type )( ::osgManipulator::Translate2DDragger &,::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter &,::osgGA::GUIActionAdapter & );
        ...
        { //::osgManipulator::Dragger::handle
            ...
            Translate2DDragger_exposer.def( 
                ...
                , default_handle_bfc7c2b1255fcef353f72f723625fd47_function_type( &Translate2DDragger_wrapper::default_handle_bfc7c2b1255fcef353f72f723625fd47 )
