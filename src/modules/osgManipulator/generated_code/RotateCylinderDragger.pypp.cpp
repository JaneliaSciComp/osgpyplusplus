...
struct RotateCylinderDragger_wrapper : osgManipulator::RotateCylinderDragger, bp::wrapper< osgManipulator::RotateCylinderDragger > {
    ...
    virtual bool handle( ::osgManipulator::PointerInfo const & pi, ::osgGA::GUIEventAdapter const & ea, ::osgGA::GUIActionAdapter & us ) {
        if( bp::override func_handle = this->get_override( "handle" ) )
            ...
            return this->osgManipulator::RotateCylinderDragger::handle( boost::ref(pi), boost::ref(ea), boost::ref(us) );
        }
    }
...
void register_RotateCylinderDragger_class(){
    ...
    bp::class_< RotateCylinderDragger_wrapper, bp::bases< osgManipulator::Dragger >, osg::ref_ptr< ::osgManipulator::RotateCylinderDragger >, boost::noncopyable >( "RotateCylinderDragger", "\n Dragger for performing 3D rotation on a cylinder.\n", bp::no_init )    
        ...
        .def( 
            "handle"
            , (bool ( ::osgManipulator::RotateCylinderDragger::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&::osgManipulator::RotateCylinderDragger::handle)
            , (bool ( RotateCylinderDragger_wrapper::* )( ::osgManipulator::PointerInfo const &,::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&RotateCylinderDragger_wrapper::default_handle)
        ...
        .def( 
            ...
            , (void ( RotateCylinderDragger_wrapper::* )( ::osgManipulator::MotionCommand & ))(&RotateCylinderDragger_wrapper::default_dispatch)
            , ( bp::arg("command") ) )    
        .def( 
            "getComposite"
        ...
        .def( 
            ...
            , (bool ( RotateCylinderDragger_wrapper::* )( ::osgGA::GUIEventAdapter const &,::osgGA::GUIActionAdapter & ))(&RotateCylinderDragger_wrapper::default_handle)
            , ( bp::arg("ea"), bp::arg("aa") ) )    
        .def( 
            "receive"
            , (bool ( ::osgManipulator::Dragger::* )( ::osgManipulator::MotionCommand const & ))(&::osgManipulator::Dragger::receive)
            , (bool ( RotateCylinderDragger_wrapper::* )( ::osgManipulator::MotionCommand const & ))(&RotateCylinderDragger_wrapper::default_receive)
            , ( bp::arg("command") ) )    
        .def( 
            "setIntersectionMask"
